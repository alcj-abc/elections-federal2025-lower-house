...
var ca = (e, t, o) => t in e ? la(e, t, { enumerable: !0, configurable: !0, writable: !0, value: o }) : e[t] = o;
var ue = (e, t, o) => ca(e, typeof t != "symbol" ? t + "" : t, o), Lo = (e, t, o) => t.has(e) || hn("Cannot " + o);
...
const Vo = 1, $o = 2, Mn = 4, da = 8, fa = 16, ha = 1, pa = 4, va = 8, ga = 16, Na = 4, kn = 1, Pa = 2, Fn = "[", Uo = "[!", Ko = "]", ht = {}, Z = Symbol(), vn = !1, ye = 2, Bn = 4, lo = 8, co = 16, We = 32, mt = 64, qt = 128, pe = 256, Qt = 512, te = 1024, Ve = 2048, Ot = 4096, Be = 8192, uo = 16384, Wn = 32768, Mt = 65536, xa = 1 << 19, Vn = 1 << 20, bt = Symbol("$state"), $n = Symbol("legacy props"), ma = Symbol("");
var Yo = Array.isArray, Oa = Array.prototype.indexOf, jo = Array.from, Xt = Object.keys, Ct = Object.defineProperty, ot = Object.getOwnPropertyDescriptor, Aa = Object.getOwnPropertyDescriptors, La = Object.prototype, wa = Array.prototype, Un = Object.getPrototypeOf;
function Ta(e) {
...
// @__NO_SIDE_EFFECTS__
function Fa(e) {
  return W !== null && !Oe && W.f & ye && (Ee === null ? $a([e]) : Ee.push(e)), e;
}
function F(e, t) {
  return W !== null && !Oe && gr() && W.f & (ye | co) && // If the source was created locally within the current derived, then
  // we allow the mutation.
  (Ee === null || !Ee.includes(e)) && Ma(), _o(e, t);
}
function _o(e, t) {
  return e.equals(t) || (e.v, e.v = t, e.wv = rr(), qn(e, Ve), D !== null && D.f & te && !(D.f & (We | mt)) && (Me === null ? Ua([e]) : Me.push(e))), t;
}
function qn(e, t) {
  var o = e.reactions;
  if (o !== null)
...
function Xn(e) {
  var t = Va(e), o = (qe || e.f & pe) && e.deps !== null ? Ot : te;
...
function re(e, t = null, o) {
  ...
  if (n !== La && n !== wa)
    return e;
  var r = /* @__PURE__ */ new Map(), a = Yo(e), s = ne(0);
  a && r.set("length", ne(
    /** @type {any[]} */
    e.length
  ));
...
function ee(e, t = 1, o = !1) {
  ...
  if (o && a !== 3) {
    var s = Nt();
    return n === null ? r == null || r.after(s) : n.before(s), ve(s), s;
  }
...
function kt(e) {
  ...
  if (t & Ot) {
    ...
    if (o !== null) {
      var r, a, s = (t & Qt) !== 0, i = n && D !== null && !qe, u = o.length;
      if (s || i) {
        var l = (
          /** @type {Derived} */
          e
        ...
        s && (l.f ^= Qt), i && d !== null && !(d.f & pe) && (l.f ^= pe);
      }
      for (r = 0; r < u; r++)
        if (a = o[r], kt(
          /** @type {Derived} */
  ...
  if (n !== null)
    for (var r = 0; r < n.length; r++) {
      ...
      a.f & ye ? ar(
        ...
        t,
        !1
      ) : t === a && (o ? Ie(a, Ve) : a.f & te && Ie(a, Ot), vo(
        /** @type {Effect} */
        a
      ));
    }
...
function sr(e) {
  var p;
  var t = J, o = se, n = Me, r = W, a = qe, s = Ee, i = z, u = Oe, l = e.f;
  J = /** @type {null | Value[]} */
  null, se = 0, Me = null, qe = (l & pe) !== 0 && (Oe || !Kt || W === null), W = l & (We | mt) ? null : e, Ee = null, On(e.ctx), Oe = !1, eo++;
  try {
    var d = (
      /** @type {Function} */
      (0, e.fn)()
    ...
    if (J !== null) {
      var f;
      if (to(e, se), c !== null && se > 0)
        for (c.length = se + J.length, f = 0; f < J.length; f++)
          c[se + f] = J[f];
      else
        e.deps = c = J;
      if (!qe)
        for (f = se; f < c.length; f++)
          ((p = c[f]).reactions ?? (p.reactions = [])).push(e);
    } else c !== null && se < c.length && (to(e, se), c.length = se);
    ...
    J = t, se = o, Me = n, W = r, qe = a, Ee = s, On(i), Oe = u;
  }
}
function ja(e, t) {
  let o = t.reactions;
...
function Qa(e) {
  var t = [], o = e.first;
  e: for (; o !== null; ) {
    var n = o.f, r = (n & We) !== 0, a = r && (n & te) !== 0, s = o.next;
    if (!a && !(n & Be)) {
      if (n & Bn)
        t.push(o);
      else if (r)
...
function P(e) {
  var t = e.f, o = (t & ye) !== 0;
  if (W !== null && !Oe) {
    Ee !== null && Ee.includes(e) && Da();
    var n = W.deps;
    e.rv < eo && (e.rv = eo, J === null && n !== null && n[se] === e ? se++ : J === null ? J = [e] : (!qe || !J.includes(e)) && J.push(e));
...
function Za(e) {
  D === null && W === null && Ca(), W !== null && W.f & pe && D === null && Ra(), qo && ba();
}
function Ja(e, t) {
  var o = t.last;
...
function it(e, t, o, n = !0) {
  ...
  var i = o && s.deps === null && s.first === null && s.nodes_start === null && s.teardown === null && (s.f & (Vn | qt)) === 0;
  if (!i && !r && n && (a !== null && Ja(s, a), W !== null && W.f & ye)) {
    var u = (
      /** @type {Derived} */
      W
    );
...
function be(e, t = !0) {
  var o = !1;
  if ((t || e.f & xa) && e.nodes_start !== null) {
...
function Zo(e, t, o) {
  if (!(e.f & Be)) {
    ...
    for (var n = e.first; n !== null; ) {
      var r = n.next, a = (n.f & Mt) !== 0 || (n.f & We) !== 0;
      Zo(n, t, a ? o : !1), n = r;
    }
  }
}
    ...
    if (s !== null) {
      ...
      try {
        for (var r = 0; r < s.length; r++) {
          var a = s[r];
          He(a.effect), Se(a.reaction), Ft(a.fn);
        }
      } finally {
        He(o), Se(n);
      }
...
function Nr(e) {
  return z === null && pr(), z.c ?? (z.c = new Map(rs(z) || void 0));
}
function rs(e) {
  let t = e.p;
  for (; t !== null; ) {
...
function mr(e, t, o, n = {}) {
  function r(a) {
    if (n.capture || _t.call(t, a), !a.cancelBubble)
      return Pr(() => o == null ? void 0 : o.call(this, a));
  }
...
function hs(e, t, o, n, r) {
  var a = { capture: n, passive: r }, s = mr(e, t, o, a);
...
// @__NO_SIDE_EFFECTS__
function $e(e, t) {
  var o = (t & kn) !== 0, n = (t & Pa) !== 0, r, a = !e.startsWith("<!>");
  return () => {
    if (H)
      return Te(I, null), I;
    r === void 0 && (r = Jo(a ? e : "<!>" + e), o || (r = /** @type {Node} */
    /* @__PURE__ */ X(r)));
    var s = (
      /** @type {TemplateNode} */
...
function Re(e, t, o = "svg") {
  var n = !e.startsWith("<!>"), r = (t & kn) !== 0, a = `<${o}>${n ? e : "<!>" + e}</${o}>`, s;
  return () => {
    if (H)
      return Te(I, null), I;
    if (!s) {
      ...
      if (r)
        for (s = document.createDocumentFragment(); /* @__PURE__ */ X(u); )
          s.appendChild(
            /** @type {Node} */
            /* @__PURE__ */ X(u)
          );
...
function ps(e, t) {
  ...
  try {
    ...
    if (s === ht)
      return t.recover === !1 && Sa(), Ro(), or(o), Le(!1), Ar(e, t);
    throw s;
  } finally {
    Le(n), ve(r);
  }
...
function Lr(e, { target: t, anchor: o, props: n = {}, events: r, context: a, intro: s = !0 }) {
  Ro();
  ...
  var l = void 0, d = ts(() => {
    ...
    return Qe(() => {
      ...
      r && (n.$$events = r), H && Te(
        ...
        c,
        null
      ), Eo = s, l = e(c, n) || {}, Eo = !0, H && (D.nodes_end = I), a && ce();
    }), () => {
      var h;
      for (var f of i) {
...
function Ae(e, t, o = !1) {
  H && rt();
  var n = e, r = null, a = null, s = Z, i = o ? Mt : 0, u = !1;
  const l = (c, f = !0) => {
    u = !0, d(f, c);
  }, d = (c, f) => {
    if (s === (s = c)) return;
    ...
    if (H) {
      ...
      !!s === h && (n = bo(), ve(n), Le(!1), p = !0);
    }
    s ? (r ? oo(r) : f && (r = Qe(() => f(n))), a && St(a, () => {
      a = null;
    })) : (a ? oo(a) : f && (a = Qe(() => f(n))), r && St(r, () => {
      r = null;
    })), p && Le(!0);
  };
  Lt(() => {
...
function Ze(e, t, o, n, r, a = null) {
  var s = e, i = { flags: t, items: /* @__PURE__ */ new Map(), first: null }, u = (t & Mn) !== 0;
  if (u) {
    var l = (
      /** @type {Element} */
      e
  ...
  Lt(() => {
    ...
    H || Ps(p, i, s, r, t, n, o), a !== null && (h === 0 ? d ? oo(d) : d = Qe(() => a(s)) : d !== null && St(d, () => {
      d = null;
    })), g && Le(!0), P(f);
  }), H && (s = I);
}
function Ps(e, t, o, n, r, a, s) {
  var E, G, $, K;
  var i = (r & da) !== 0, u = (r & (Vo | $o)) !== 0, l = e.length, d = t.items, c = t.first, f = c, p, h = null, g, v = [], L = [], y, x, N, m;
  if (i)
    for (m = 0; m < l; m += 1)
      y = e[m], x = a(y, m), N = d.get(x), N !== void 0 && ((E = N.a) == null || E.measure(), (g ?? (g = /* @__PURE__ */ new Set())).add(N));
  for (m = 0; m < l; m += 1) {
    if (y = e[m], x = a(y, m), N = d.get(x), N === void 0) {
      var T = f ? (
        /** @type {TemplateNode} */
        f.e.nodes_start
      ) : o;
    ...
    if (u && xs(N, y, m, r), N.e.f & Be && (oo(N.e), i && ((G = N.a) == null || G.unfix(), (g ?? (g = /* @__PURE__ */ new Set())).delete(N))), N !== f) {
      if (p !== void 0 && p.has(N)) {
...
function wr(e, t, o, n, r, a, s, i, u, l) {
  var d = (u & Vo) !== 0, c = (u & fa) === 0, f = d ? c ? /* @__PURE__ */ fo(r) : ne(r) : r, p = u & $o ? ne(s) : s, h = {
    i: p,
    v: f,
    k: a,
    a: null,
...
function Tr(e) {
  ...
  if (typeof e == "string" || typeof e == "number") n += e;
    ...
    var r = e.length;
    for (t = 0; t < r; t++) e[t] && (o = Tr(e[t])) && (n && (n += " "), n += o);
  } else for (o in e) e[o] && (n && (n += " "), n += o);
  return n;
}
function Os() {
  for (var e, t, o = 0, n = "", r = arguments.length; o < r; o++) (e = arguments[o]) && (t = Tr(e)) && (n && (n += " "), n += t);
  return n;
}
function As(e) {
...
function we(e, t, o, n) {
  ...
  H && (r[t] = e.getAttribute(t), t === "src" || t === "srcset" || t === "href" && e.nodeName === "LINK") || r[t] !== (r[t] = o) && (t === "style" && "__styles" in e && (e.__styles = {}), t === "loading" && (e[ma] = o), o == null ? e.removeAttribute(t) : typeof o != "string" && yr(e).includes(t) ? e[t] = o : e.setAttribute(t, o));
}
function Ho(e, t, o, n, r = !1, a = !1, s = !1) {
  let i = H && a;
  i && Le(!1);
  var u = t || {}, l = e.tagName === "OPTION";
  for (var d in t)
    d in o || (o[d] = null);
  o.class ? o.class = As(o.class) : (n || o[Yt]) && (o.class = null);
  var c = yr(e), f = (
    ...
    if (!(N === p && x !== "class")) {
      ...
      if (h !== "$$") {
        if (h === "on") {
          ...
          let b = x.slice(2);
          var g = is(b);
          if (as(b) && (b = b.slice(0, -7), m.capture = !0), !g && p) {
            if (N != null) continue;
            e.removeEventListener(b, u[T], m), u[T] = null;
          }
          if (N != null)
            if (g)
              e[`__${b}`] = N, Or([b]);
        ...
        else if (!a && (x === "__value" || x === "value" && N != null))
          e.value = e.__value = N;
          ...
          if (N == null && !a && !y)
            if (f[x] = null, L === "value" || L === "checked") {
              ...
              if (L === "value") {
                ...
                m.removeAttribute(L), m.defaultValue = b, m.value = m.__value = T ? b : null;
              } else {
                let b = m.defaultChecked;
                m.removeAttribute(L), m.defaultChecked = b, m.checked = T ? b : !1;
              }
            } else
              e.removeAttribute(x);
          else y || c.includes(L) && (a || typeof N != "string") ? e[L] = N : typeof N != "function" && we(e, L, N);
        }
...
const _s = (e) => e;
function Pt(e, t, o, n) {
  var r = (e & Na) !== 0, a = "both", s, i = t.inert, u = t.style.overflow, l, d;
  function c() {
    var v = W, L = D;
    Se(null), He(null);
    try {
  ...
  var f = {
    ...
    in() {
      t.inert = i, Wt(t, "introstart"), l = Io(t, c(), d, 1, () => {
        Wt(t, "introend"), l == null || l.abort(), l = s = void 0, t.style.overflow = u;
      });
    },
    out(v) {
...
function Io(e, t, o, n, r) {
  ...
  const { delay: u = 0, css: l, tick: d, easing: c = _s } = t;
  var f = [];
  if (a && o === void 0 && (d && d(0, 1), l)) {
    var p = Tn(l(0, 1));
    f.push(p, p);
  }
  ...
  return g.onfinish = () => {
    ...
    if (y > 0) {
      var N = !1;
      if (l)
        for (var m = Math.ceil(y / 16.666666666666668), T = 0; T <= m; T += 1) {
          var b = v + L * c(T / m), C = Tn(l(b, 1 - b));
...
const io = class io {
  ...
  observe(t, o) {
    ...
    return n.add(o), S(this, ze).set(t, n), pn(this, so, Rr).call(this).observe(t, S(this, Gt)), () => {
      var r = S(this, ze).get(t);
      r.delete(o), r.size === 0 && (S(this, ze).delete(t), S(this, vt).unobserve(t));
    };
  }
};
ze = new WeakMap(), vt = new WeakMap(), Gt = new WeakMap(), so = new WeakSet(), Rr = function() {
...
let Go = io;
var bs = /* @__PURE__ */ new Go({
  box: "border-box"
});
function Rs(e, t, o) {
  var n = bs.observe(e, () => o(e[t]));
  Ft(() => (at(() => o(e[t])), n));
}
function yn(e, t) {
...
function go(e = {}, t, o, n) {
  return Ft(() => {
    ...
    return Xo(() => {
      r = a, a = [], at(() => {
        e !== o(...a) && (t(e, ...a), r && yn(o(...r), e) && t(null, ...r));
      });
    }), () => {
      At(() => {
        a && yn(o(...a), e) && t(null, ...a);
...
function no(e, t = ie) {
  ...
  function s(i, u = ie) {
    const l = [i, u];
    return n.add(l), n.size === 1 && (o = t(r, a) || ie), i(
      /** @type {T} */
      e
    ), () => {
...
function Cs(e, t, o) {
  ...
  if (n.store !== e && !(Do in o))
    if (n.unsubscribe(), n.store = e ?? null, e == null)
      ...
      var r = !0;
      n.unsubscribe = Cr(e, (a) => {
        r ? n.source.v = a : F(n.source, a);
      }), r = !1;
    }
...
function A(e, t, o, n) {
  var m;
  var r = (o & ha) !== 0, a = !0, s = (o & va) !== 0, i = (o & ga) !== 0, u = !1, l;
  s ? [l, u] = Es(() => (
    /** @type {V} */
    e[t]
  )) : l = /** @type {V} */
  e[t];
  var d = bt in e || $n in e, c = s && (((m = ot(e, t)) == null ? void 0 : m.set) ?? (d && t in e && ((T) => e[t] = T))) || void 0, f = (
    /** @type {V} */
    n
  ), p = !0, h = !1, g = () => (h = !0, p && (p = !1, i ? f = at(
    /** @type {() => V} */
    n
  ) : f = /** @type {V} */
  n), f);
  l === void 0 && n !== void 0 && (c && a && Ha(), l = g(), c && c(l));
  var v;
  if (v = () => {
    var T = (
      /** @type {V} */
    ...
    return T === void 0 ? g() : (p = !0, h = !1, T);
  }, !(o & pa))
    return v;
  if (c) {
    var L = e.$$legacy;
    return function(T, b) {
      return arguments.length > 0 ? ((!b || L || u) && c(b ? v() : T), T) : v();
    };
  }
  var y = !1, x = /* @__PURE__ */ fo(l), N = /* @__PURE__ */ Y(() => {
    var T = v(), b = P(x);
    return y ? (y = !1, b) : x.v = T;
  });
  return r || (N.equals = zo), function(T, b) {
    if (arguments.length > 0) {
      const C = b ? P(N) : s ? re(T) : T;
      return N.equals(C) || (y = !0, F(x, C), h && f !== void 0 && (f = C), at(() => P(N))), T;
    }
    return P(N);
  };
}
  ...
  constructor(t) {
    ...
    const r = new Proxy(
      { ...t.props || {}, $$events: {} },
      {
        ...
        has(s, i) {
          return i === $n ? !0 : (P(o.get(i) ?? n(i, Reflect.get(s, i))), Reflect.has(s, i));
        },
        set(s, i, u) {
          return F(o.get(i) ?? n(i, u), u), Reflect.set(s, i, u);
        }
      }
    );
    et(this, de, (t.hydrate ? ps : Ar)(t.component, {
      target: t.target,
      anchor: t.anchor,
      props: r,
      context: t.context,
      intro: t.intro ?? !1,
      recover: t.recover
    })), (!((a = t == null ? void 0 : t.props) != null && a.$$host) || t.sync === !1) && O(), et(this, ke, r.$$events);
    for (const s of Object.keys(S(this, de)))
  ...
  set(t, o) {
    ...
    return et(this, tt, br((f) => {
      ...
      if (!l) {
        l = !0;
        const h = S(this, Fe).v;
        u = s(h, t), typeof r == "function" && (r = r(h, t)), d == null || d.abort();
      }
      const p = f - i;
      return p > /** @type {number} */
      r ? (F(S(this, Fe), t), !1) : (F(S(this, Fe), u(a(p / /** @type {number} */
      r))), !0);
    })), S(this, tt).promise;
  }
  get current() {
...
let ft = rn;
const Ms = (e) => e;
function xt(e, { delay: t = 0, duration: o = 400, easing: n = Ms } = {}) {
...
var ks = /* @__PURE__ */ $e('<div class="state-labels__label svelte-1uzomw4"> </div>'), Fs = /* @__PURE__ */ $e('<div aria-hidden="true"></div>');
const Bs = {
  hash: "svelte-1uzomw4",
...
function Hr(e, t) {
  ...
  }), B(r), _e(() => a = en(r, 1, "state-labels svelte-1uzomw4", null, a, { "state-labels--overlaid": n() })), V(e, r), ce({
    get labels() {
      return o();
    },
    set labels(s) {
...
var Ws = /* @__PURE__ */ $e('<span class="accessible-hide svelte-ivafae"><!></span>');
const Vs = {
  hash: "svelte-ivafae",
...
var Ys = /* @__PURE__ */ $e("<li><button> </button></li>"), js = /* @__PURE__ */ $e("<li> <ul></ul></li>"), zs = /* @__PURE__ */ $e('<ul class="hexmapkeyboardnav svelte-1vj52vk"></ul>');
const qs = {
  hash: "svelte-1vj52vk",
...
function Gr(e, t) {
  le(t, !0), Je(e, qs);
  let o = A(t, "groups", 7), n = A(t, "layout", 7), r = A(t, "onChange", 7), a = A(t, "onClick", 7), s = A(t, "onFocus", 7), i = A(t, "customElectorateAltText", 23, () => ({})), u = fe(null);
  Ge(() => {
    var d;
    (d = r()) == null || d(P(u));
  });
  ...
  return Ir(e, {
    children: (d, c) => {
      var f = zs();
      f.__click = [Us, a], f.__focusin = [$s, u, s], f.__focusout = [Ks, u, s], Ze(f, 21, () => P(l), Xe, (p, h) => {
        var g = js(), v = U(g), L = ee(v);
        Ze(L, 21, () => P(h).hexes, Xe, (y, x) => {
          var N = Ys(), m = U(N), T = U(m);
          B(m), B(N), _e(() => {
            we(m, "data-id", P(x).id), Ht(T, `${P(x).name ?? ""} ${i()[P(x).id] || ""}`);
          }), V(y, N);
...
function zt(e, t) {
  le(t, !0), Je(e, Js);
  let o = A(t, "groups", 7), n = A(t, "id", 7), r = A(t, "layout", 7), a = A(t, "type", 7, "focus"), s = /* @__PURE__ */ Y(() => o().flatMap((c) => c.hexes.map((f) => ({ ...f, group: c.name }))).sort((c, f) => c.index - f.index)), i = /* @__PURE__ */ Y(() => {
    if (!n())
      return;
    const c = P(s).find((x) => x.id === n()), [f, p] = r().positions[c.group], [h, g] = c.coord, v = g % 2 ? 0.5 : 0, [L, y] = Po([f + h + v, p + g], "").map(Number);
    return [L - 3, y - 3];
  });
  var u = pt(), l = nt(u);
  {
...
var ai = Object.prototype, si = ai.toString;
function ii(e) {
  return si.call(e);
}
...
var wo = function() {
  return Dr.Date.now();
}, Ai = "Expected a function", Li = Math.max, wi = Math.min;
function Ti(e, t, o) {
  var n, r, a, s, i, u, l = 0, d = !1, c = !1, f = !0;
  if (typeof e != "function")
    throw new TypeError(Ai);
  t = En(t) || 0, ko(o) && (d = !!o.leading, c = "maxWait" in o, a = c ? Li(En(o.maxWait) || 0, t) : a, f = "trailing" in o ? !!o.trailing : f);
  function p(T) {
    var b = n, C = r;
    return n = r = void 0, l = T, s = e.apply(C, b), s;
  }
  function h(T) {
    return l = T, i = setTimeout(L, t), d ? p(T) : s;
  }
  function g(T) {
    var b = T - u, C = T - l, M = t - b;
    return c ? wi(M, a - C) : M;
  }
  function v(T) {
    var b = T - u, C = T - l;
    return u === void 0 || b >= t || b < 0 || c && C >= a;
  }
  function L() {
    var T = wo();
    if (v(T))
  ...
  function y(T) {
    return i = void 0, f && n ? p(T) : (n = r = void 0, s);
  }
  function x() {
    i !== void 0 && clearTimeout(i), l = 0, n = u = r = i = void 0;
  }
  function N() {
    return i === void 0 ? s : y(wo());
  }
  function m() {
    var T = wo(), b = v(T);
    if (n = arguments, r = this, u = T, b) {
      if (i === void 0)
        return h(u);
      if (c)
...
function yi({ isInteractive: e = !1, onClick: t, onHover: o }) {
  if (!e)
    return {};
  const n = Ti(o, 10), r = ({ target: i, clientX: u, clientY: l }) => {
    var c;
...
function kr(e, t) {
  le(t, !0), Je(e, Ri);
  let o = A(t, "hexes", 7), n = A(t, "allocations", 7), r = A(t, "certainties", 7), a = A(t, "labelsToShow", 23, () => ({})), s = A(t, "showElectorateLabels", 7, !1), i = /* @__PURE__ */ Y(() => s() ? o() : o().filter(({ id: l }) => a()[l]));
  var u = bi();
  return Ze(u, 21, () => P(i), Xe, (l, d) => {
    ...
    B(y), B(h), _e(
      (N) => {
        we(h, "transform", N), v = en(g, 0, "hexlabels__text svelte-1kzhlql", null, v, {
...
var Ci = /* @__PURE__ */ Re('<g class="group-outline group-outline__under svelte-1fpog18"><!></g>'), Ei = /* @__PURE__ */ Re('<g><g class="group-hexes svelte-1fpog18"><!></g><!></g>'), Si = /* @__PURE__ */ Re('<g class="group-outline group-outline__over svelte-1fpog18"><!></g>'), Hi = /* @__PURE__ */ Re('<g><g class="group-hex-strokes svelte-1fpog18"><!></g><!><!></g>'), Ii = /* @__PURE__ */ Re('<g class="svelte-1fpog18"><!><!></g>');
const Gi = {
  hash: "svelte-1fpog18",
...
function Fr(e, t) {
  le(t, !0), Je(e, Gi);
  let o = A(t, "groups", 7), n = A(t, "isStaticLayout", 7), r = A(t, "layout", 7), a = A(t, "allocations", 7), s = A(t, "focuses", 7), i = A(t, "certainties", 7), u = A(t, "showElectorateLabels", 7), l = A(t, "showFocusedElectorateLabels", 7), d = A(t, "labelsToShow", 7), c = A(t, "isOutlineOnly", 7, !1), f = A(t, "showStateOutlinesOnTop", 7, !1), p = A(t, "hexFlip", 7, "None"), h = fe(void 0), g = fe(!1);
  st(() => {
    setTimeout(
      () => {
        F(g, !0);
  ...
  }), y = /* @__PURE__ */ Y(() => Object.values(s()).some(Boolean)), x = /* @__PURE__ */ Y(() => {
    var R;
  ...
  let m = /* @__PURE__ */ Y(() => {
    const R = o(), k = r();
    return R.map((q) => {
      const _ = k.positions[q.name], E = _ && _[0] !== 1 / 0, G = Po(_).join(","), $ = P(y) && l() ? s() : d(), K = {
        "data-name": q.name,
  ...
  Ze(C, 17, () => P(m), Xe, (R, k) => {
    ...
    var j = ee($);
    {
      var Ne = (ae) => {
        var oe = Ci(), Ue = U(oe);
        Bt(Ue, () => _().svgOutline), B(oe), Pt(3, oe, () => xt, () => ({ duration: 200 })), V(ae, oe);
      };
      Ae(j, (ae) => {
        P(T) || ae(Ne);
      });
    }
    B(E), _e(() => G = Ho(E, G, { ...q() }, "svelte-1fpog18", !0)), V(R, E);
  });
  var M = ee(C);
  return Ze(M, 17, () => P(m), Xe, (R, k) => {
    ...
    B($), _e(() => K = Ho($, K, { ...q() }, "svelte-1fpog18", !0)), V(R, $);
  }), B(b), go(b, (R) => F(h, R), () => P(h)), hs("animationend", b, (R) => {
...
function tn(e, t) {
  le(t, !0), Je(e, ki);
  let o = A(t, "hexes", 7), n = A(t, "offset", 7), r = A(t, "arrowData", 7), a = A(t, "arrowHeight", 7), s = A(t, "getColourForValue", 7), i = A(t, "getRotationForValue", 7), u = /* @__PURE__ */ Y(() => o().map((c) => ({
    id: c.id,
    coordPx: c.coordPx,
    value: r()[c.id]
  ...
  return Ze(d, 21, () => P(u), Xe, (c, f) => {
    ...
    B(g), _e(
      (y, x, N, m) => {
        we(g, "transform", y), he(g, "opacity", h() === 0 ? 0 : 1), we(v, "transform", x), he(v, "fill", N), we(L, "transform", m), he(L, "stroke", N);
      },
      [
        () => `translate(${p().join(" ")}) rotate(${i()(h())})`,
        () => `scale(${l(h())} ${h() * a()})`,
        () => s()(h()),
        () => `translate(0 ${-63 * h() * a()}) rotate(${h() < 0 ? 180 : 0}) scale(${l(h())})`
      ]
    ), V(c, g);
  }), B(d), _e((c) => we(d, "transform", c), [
    () => `translate(${Po(n(), "").join(",")})`
...
const Fi = { pct: { OTH: 11.47, IND: 7.84, TOP: 2.27, LNP: 29.82, ALP: 36.18, GRN: 12.42 } }, Bi = { pct: { IND: 4.6, ALP: 39.62, GRN: 22.81, LNP: 27.25, OTH: 4.18, TOP: 1.54 } }, Wi = { pct: { TOP: 3.95, OTH: 4.92, GRN: 13.99, ALP: 43.52, LNP: 33.62 } }, Vi = { pct: { LNP: 47.25, GRN: 5.4, ALP: 33.73, TOP: 2.05, OTH: 11.56 } }, $i = { pct: { ALP: 44.5, LNP: 30.3, TOP: 2.07, OTH: 11.65, GRN: 8.17, ONP: 3.31 } }, Ui = { pct: { ALP: 32.27, TOP: 1.86, LNP: 48.2, GRN: 8.98, OTH: 8.69 } }, Ki = { pct: { GRN: 11.12, LNP: 53.54, TOP: 1.57, OTH: 11.43, IND: 2.59, ALP: 19.75 } }, Yi = { pct: { OTH: 17.78, LNP: 24.99, ALP: 50.09, TOP: 2.5, GRN: 4.64 } }, ji = { pct: { GRN: 13.15, LNP: 57.89, TOP: 1.77, OTH: 6.87, ALP: 20.32 } }, zi = { pct: { OTH: 28.18, ALP: 20.87, TOP: 3.05, LNP: 42.19, GRN: 5.71 } }, qi = { pct: { OTH: 15.47, IND: 1.57, TOP: 4.1, GRN: 4.57, LNP: 25.23, ALP: 49.06 } }, Qi = { pct: { LNP: 59.8, OTH: 7.72, ALP: 21.68, ONP: 3.27, GRN: 6.4, TOP: 1.13 } }, Xi = { pct: { OTH: 11.76, LNP: 43.41, TOP: 2.79, ALP: 12.72, IND: 23.86, GRN: 5.47 } }, Zi = { pct: { LNP: 29.2, GRN: 14.23, ALP: 43.95, OTH: 9.02, TOP: 3.59 } }, Ji = { pct: { TOP: 5.02, OTH: 7.7, LNP: 38.3, GRN: 7.02, ALP: 39.01, IND: 2.94 } }, el = { pct: { ALP: 36.5, LNP: 40.97, GRN: 8.18, IND: 3.88, OTH: 7.89, TOP: 2.58 } }, tl = { pct: { LNP: 46.08, OTH: 12.72, ALP: 13.3, IND: 19.79, TOP: 3.88, GRN: 4.23 } }, ol = { pct: { OTH: 17.93, ALP: 47.39, TOP: 3.76, GRN: 4.81, LNP: 26.11 } }, nl = { pct: { GRN: 9.45, IND: 6.67, TOP: 3.2, ALP: 34.29, OTH: 6.88, LNP: 39.5 } }, rl = { pct: { OTH: 7.73, LNP: 20.83, TOP: 1.15, GRN: 21.59, ALP: 48.69 } }, al = { pct: { OTH: 11.39, GRN: 5.13, LNP: 37.84, ALP: 42.86, TOP: 2.79 } }, sl = { pct: { LNP: 50.41, GRN: 6.58, OTH: 9.79, TOP: 2.35, ALP: 28.89, IND: 1.97 } }, il = { pct: { ALP: 24.86, TOP: 4.51, OTH: 10.48, LNP: 49.84, GRN: 4.77, IND: 5.54 } }, ll = { pct: { ONP: 19.66, LNP: 21.36, OTH: 14.6, TOP: 3.93, GRN: 6.25, ALP: 34.2 } }, cl = { pct: { GRN: 11.4, OTH: 10.09, ALP: 42.55, TOP: 1.65, LNP: 34.32 } }, ul = { pct: { OTH: 17.53, ALP: 31.67, LNP: 41.31, GRN: 4.36, TOP: 2.58, IND: 2.54 } }, dl = { pct: { ALP: 21.9, LNP: 44.87, TOP: 3.68, OTH: 18.98, IND: 4.65, GRN: 5.92 } }, fl = { pct: { OTH: 14.17, ALP: 43.55, ONP: 7.84, LNP: 28.12, TOP: 2.3, GRN: 4.03 } }, hl = { pct: { TOP: 2.25, OTH: 8.54, IND: 11.61, GRN: 10.94, ALP: 16.14, LNP: 50.51 } }, pl = { pct: { LNP: 42.93, GRN: 8.76, ALP: 36.63, OTH: 7.85, TOP: 3.83 } }, vl = { pct: { TOP: 3.43, ONP: 7.25, OTH: 15.18, ALP: 40.52, GRN: 4.34, LNP: 29.28 } }, gl = { pct: { ALP: 22.74, LNP: 58.92, TOP: 2.6, OTH: 8.08, GRN: 7.66 } }, Nl = { pct: { IND: 19.7, OTH: 8.94, ALP: 11.88, LNP: 51.08, GRN: 4.13, TOP: 4.27 } }, Pl = { pct: { ALP: 43.21, GRN: 14.7, OTH: 11.3, TOP: 3.18, LNP: 27.6 } }, xl = { pct: { IND: 4.61, OTH: 8.84, TOP: 3.05, GRN: 11.13, LNP: 47.27, ALP: 25.11 } }, ml = { pct: { OTH: 13.44, LNP: 47.79, GRN: 3.93, ALP: 22.18, IND: 6.74, TOP: 5.92 } }, Ol = { pct: { LNP: 37.83, ALP: 41.31, TOP: 2.37, GRN: 6.63, OTH: 11.87 } }, Al = { pct: { LNP: 30.62, ONP: 13.33, ALP: 38.68, TOP: 3.4, GRN: 6.5, OTH: 7.48 } }, Ll = { pct: { OTH: 10.33, GRN: 7.59, ALP: 34.93, LNP: 45.36, TOP: 1.8 } }, wl = { pct: { OTH: 12.67, TOP: 3.61, ALP: 29.35, IND: 1.44, LNP: 34.12, GRN: 18.81 } }, Tl = { pct: { LNP: 56.84, GRN: 5.88, ALP: 21.97, TOP: 10.16, OTH: 5.16 } }, yl = { pct: { OTH: 12.13, TOP: 2.61, IND: 2.81, LNP: 43.47, GRN: 7.34, ALP: 31.64 } }, _l = { pct: { OTH: 14.56, ALP: 38.5, TOP: 4.24, GRN: 7.73, LNP: 34.98 } }, bl = { pct: { LNP: 25.6, OTH: 8.1, ALP: 47.53, TOP: 1.39, GRN: 17.38 } }, Rl = { pct: { OTH: 7.81, IND: 42.41, ALP: 6.28, TOP: 0.64, LNP: 37.04, GRN: 5.82 } }, Cl = { pct: { TOP: 3.68, OTH: 19.25, GRN: 6.2, ALP: 45.17, LNP: 25.69 } }, El = { pct: { IND: 32.02, ALP: 10.62, TOP: 0.68, OTH: 3.37, LNP: 46.01, GRN: 7.31 } }, Sl = { pct: { OTH: 16.11, LNP: 31.19, GRN: 4.75, IND: 2, TOP: 3.71, ALP: 42.23 } }, Hl = { pct: { TOP: 8.19, OTH: 14.38, LNP: 23.62, ALP: 45.26, GRN: 8.55 } }, Il = { pct: { ALP: 42.54, GRN: 7.82, TOP: 2.68, OTH: 7.75, IND: 4.16, LNP: 35.04 } }, Gl = { pct: { ALP: 38.29, OTH: 6.59, LNP: 36.39, GRN: 11.32, TOP: 2.75, IND: 4.66 } }, Dl = { pct: { IND: 5.75, OTH: 11.76, ALP: 28.92, ONP: 15.54, LNP: 26.85, TOP: 3.14, GRN: 8.03 } }, Ml = { pct: { TOP: 2.47, GRN: 11.35, ONP: 3.89, LNP: 48.04, OTH: 4.07, ALP: 30.19 } }, kl = { pct: { GRN: 11.59, LNP: 47.02, TOP: 3.48, OTH: 5.19, ONP: 7.05, ALP: 25.68 } }, Fl = { pct: { ONP: 2.43, LNP: 46.64, TOP: 1.36, GRN: 21.81, OTH: 3.9, ALP: 23.87 } }, Bl = { pct: { GRN: 4.53, OTH: 13.5, IND: 2.33, LNP: 38.08, ALP: 22.24, ONP: 15.9, TOP: 3.42 } }, Wl = { pct: { OTH: 17.68, ONP: 12.17, LNP: 39.94, ALP: 18.86, GRN: 4.2, IND: 2.59, TOP: 4.56 } }, Vl = { pct: { GRN: 9.54, LNP: 43.93, ALP: 29.96, IND: 2.27, TOP: 2.15, ONP: 4.95, OTH: 7.19 } }, $l = { pct: { OTH: 10.7, ALP: 21.4, ONP: 8.15, GRN: 8.56, LNP: 46.33, TOP: 4.86 } }, Ul = { pct: { TOP: 2.86, OTH: 10.23, GRN: 11.78, LNP: 46.43, ONP: 7.34, IND: 1.26, ALP: 20.1 } }, Kl = { pct: { TOP: 3.3, ALP: 21.16, GRN: 11.81, ONP: 8.26, LNP: 47.64, OTH: 7.83 } }, Yl = { pct: { ALP: 26.98, TOP: 4, GRN: 2.89, IND: 3.56, ONP: 18.46, OTH: 8.42, LNP: 35.69 } }, jl = { pct: { ONP: 11.26, GRN: 8.32, TOP: 3.85, LNP: 41.49, ALP: 28.14, OTH: 6.94 } }, zl = { pct: { LNP: 40.05, ALP: 30.26, GRN: 23.12, TOP: 1.42, ONP: 2.07, OTH: 3.09 } }, ql = { pct: { GRN: 7.71, ONP: 12.67, OTH: 6.1, LNP: 51.63, TOP: 3.84, ALP: 18.06 } }, Ql = { pct: { ONP: 10.43, TOP: 5.36, OTH: 18.45, GRN: 6.88, LNP: 34.92, ALP: 23.95 } }, Xl = { pct: { ONP: 13.64, LNP: 42.43, GRN: 3.43, IND: 4.65, OTH: 10.69, TOP: 4.03, ALP: 21.14 } }, Zl = { pct: { TOP: 6.38, OTH: 46.06, GRN: 4.95, LNP: 26.33, ALP: 16.27 } }, Jl = { pct: { OTH: 16.11, IND: 2.67, ALP: 26.94, ONP: 5.66, TOP: 3.71, LNP: 35.18, GRN: 9.73 } }, e1 = { pct: { ONP: 5.16, OTH: 5.37, LNP: 39.36, ALP: 34.4, GRN: 13.53, TOP: 2.18 } }, t1 = { pct: { LNP: 36.33, TOP: 3.16, OTH: 9.62, ALP: 32.11, ONP: 12.45, GRN: 6.32 } }, o1 = { pct: { ALP: 14.94, LNP: 53.79, OTH: 10.45, TOP: 3.49, ONP: 14.05, GRN: 3.29 } }, n1 = { pct: { ALP: 21.4, OTH: 12.84, IND: 1.67, GRN: 10.29, LNP: 45.19, TOP: 3.12, ONP: 5.49 } }, r1 = { pct: { OTH: 13.06, LNP: 48.2, ONP: 6.03, GRN: 9.06, TOP: 3.48, ALP: 20.18 } }, a1 = { pct: { OTH: 4.67, ALP: 34.1, GRN: 16.26, ONP: 3.21, LNP: 39.61, TOP: 2.16 } }, s1 = { pct: { LNP: 32.92, GRN: 11.08, ALP: 40.51, TOP: 2.49, ONP: 6, OTH: 6.99 } }, i1 = { pct: { TOP: 3.19, LNP: 46.37, ONP: 7.25, ALP: 29.74, OTH: 5.03, GRN: 8.42 } }, l1 = { pct: { ALP: 38.22, TOP: 3.41, GRN: 8.38, ONP: 7.89, OTH: 13.16, LNP: 28.93 } }, c1 = { pct: { ALP: 23.85, TOP: 1.5, OTH: 5.25, ONP: 2.11, LNP: 47.44, GRN: 19.86 } }, u1 = { pct: { GRN: 9.47, ALP: 20.72, TOP: 3.44, LNP: 44.86, IND: 4.28, OTH: 6.92, ONP: 10.32 } }, d1 = { pct: { TOP: 4.6, GRN: 6.74, IND: 5.01, ALP: 17.6, OTH: 10.71, ONP: 13.16, LNP: 42.19 } }, f1 = { pct: { OTH: 8.13, GRN: 15.14, ALP: 38.78, LNP: 34.82, TOP: 3.13 } }, h1 = { pct: { GRN: 6.46, TOP: 5.59, LNP: 54.65, OTH: 13.45, ALP: 19.84 } }, p1 = { pct: { OTH: 8.27, GRN: 11.4, LNP: 43.07, ALP: 33.01, TOP: 1.8, IND: 2.45 } }, v1 = { pct: { OTH: 14.12, ALP: 21.25, ONP: 8.09, IND: 1.62, TOP: 3.5, LNP: 47.14, GRN: 4.28 } }, g1 = { pct: { OTH: 8.95, TOP: 4.15, ALP: 41.23, LNP: 35.16, GRN: 10.51 } }, N1 = { pct: { ALP: 48.5, LNP: 30.42, GRN: 8.83, OTH: 7.49, TOP: 4.76 } }, P1 = { pct: { ALP: 46.24, LNP: 31.4, OTH: 7.95, GRN: 8.24, TOP: 6.15 } }, x1 = { pct: { LNP: 36.51, GRN: 8.98, OTH: 38.18, TOP: 3.1, ALP: 13.24 } }, m1 = { pct: { ALP: 47.91, LNP: 24.29, TOP: 6.62, GRN: 6.78, OTH: 9.34, IND: 5.06 } }, O1 = { pct: { GRN: 10.58, LNP: 47.86, ALP: 28.26, OTH: 8.51, TOP: 2.29, IND: 2.51 } }, A1 = { pct: { GRN: 10.01, ALP: 33.18, OTH: 6.82, LNP: 41.73, IND: 3.62, TOP: 4.64 } }, L1 = { pct: { TOP: 3.42, IND: 11.72, OTH: 8.02, LNP: 37.4, GRN: 4.49, ALP: 29.79, ONP: 5.15 } }, w1 = { pct: { IND: 48.82, ALP: 19.73, LNP: 16.95, GRN: 9.34, TOP: 2.72, OTH: 2.44 } }, T1 = { pct: { GRN: 15.74, LNP: 30.28, OTH: 4.88, ALP: 42.61, TOP: 6.48 } }, y1 = { pct: { LNP: 38.04, ALP: 34.79, GRN: 9.02, ONP: 7.76, TOP: 5.82, OTH: 4.57 } }, _1 = { pct: { LNP: 52.68, GRN: 8.53, ALP: 28.71, TOP: 3.47, OTH: 6.6 } }, b1 = { pct: { OTH: 8.46, TOP: 4.42, IND: 3.66, GRN: 8.45, LNP: 29.3, ALP: 45.71 } }, R1 = { pct: { OTH: 7.03, GRN: 10.74, ALP: 41.84, TOP: 4.08, LNP: 30.39, ONP: 5.92 } }, C1 = { pct: { OTH: 9.03, TOP: 4.04, LNP: 27.57, ALP: 52.47, GRN: 6.9 } }, E1 = { pct: { OTH: 19.01, GRN: 6.12, ALP: 48.91, TOP: 3.15, LNP: 22.81 } }, S1 = { pct: { IND: 2.16, OTH: 16.09, TOP: 2.44, LNP: 42.32, ALP: 26.75, GRN: 10.23 } }, H1 = { pct: { IND: 2.33, OTH: 10.64, GRN: 11.3, LNP: 41.43, TOP: 1.53, ALP: 32.76 } }, I1 = { pct: { IND: 1.62, OTH: 13.37, TOP: 1.85, GRN: 20.11, ALP: 44.5, LNP: 18.55 } }, G1 = { pct: { OTH: 9.62, ALP: 34.07, GRN: 8.68, IND: 4.85, LNP: 40.65, TOP: 2.13 } }, D1 = { pct: { ALP: 45.91, LNP: 32.64, GRN: 12.6, TOP: 5.29, OTH: 3.56 } }, M1 = { pct: { OTH: 10.75, IND: 1.59, GRN: 8.61, LNP: 45.88, TOP: 1.97, ALP: 31.2 } }, k1 = { pct: { OTH: 15.21, TOP: 2.46, ALP: 36.54, GRN: 7.96, LNP: 37.83 } }, F1 = { pct: { IND: 14.8, OTH: 9.22, LNP: 43.94, ALP: 23.27, GRN: 6.4, TOP: 2.37 } }, B1 = { pct: { TOP: 7.42, LNP: 24.27, ALP: 47.37, OTH: 7.81, GRN: 7.75, IND: 5.38 } }, W1 = { pct: { ALP: 46.95, GRN: 15.97, LNP: 28.3, TOP: 5.28, OTH: 3.51 } }, V1 = { pct: { OTH: 13.96, TOP: 4.17, ALP: 21.99, IND: 2.98, LNP: 51.18, GRN: 5.72 } }, $1 = { pct: { TOP: 1.91, OTH: 3.84, ALP: 27.68, GRN: 13.73, LNP: 51.51, IND: 1.33 } }, U1 = { pct: { TOP: 7.43, IND: 8.31, GRN: 6.69, ALP: 47.12, LNP: 24.53, OTH: 5.92 } }, K1 = { pct: { ALP: 48.64, GRN: 6.82, TOP: 6.03, LNP: 34.39, OTH: 4.12 } }, Y1 = { pct: { TOP: 3.5, ALP: 43.46, LNP: 37.58, GRN: 8.75, OTH: 6.71 } }, j1 = { pct: { GRN: 4.03, OTH: 7.1, IND: 30.94, LNP: 42.6, TOP: 3.77, ALP: 11.56 } }, z1 = { pct: { GRN: 10.71, LNP: 33.75, OTH: 8.84, ALP: 42.93, TOP: 3.77 } }, q1 = { pct: { TOP: 3.62, ALP: 40.71, OTH: 4.47, LNP: 37.4, GRN: 13.8 } }, Q1 = { pct: { TOP: 1.16, IND: 9.89, LNP: 47.94, ALP: 16.33, OTH: 4.07, GRN: 20.61 } }, X1 = { pct: { GRN: 7.5, OTH: 8.8, LNP: 43.68, ONP: 4.64, TOP: 2.43, ALP: 32.95 } }, Z1 = { pct: { OTH: 9.76, LNP: 28.84, ALP: 49.41, TOP: 4.55, GRN: 7.44 } }, J1 = { pct: { IND: 2, GRN: 23.21, OTH: 7.44, LNP: 35.79, TOP: 1.12, ALP: 30.43 } }, ec = { pct: { LNP: 41.48, IND: 19.1, OTH: 19.36, ALP: 13.94, TOP: 3, GRN: 3.12 } }, tc = { pct: { TOP: 3.48, GRN: 14.38, ALP: 45.69, LNP: 33.56, OTH: 2.9 } }, oc = { pct: { GRN: 7.91, OTH: 11.93, ALP: 37.36, LNP: 32.68, IND: 1.53, ONP: 5.61, TOP: 2.97 } }, nc = { pct: { OTH: 9.9, GRN: 47.81, IND: 1.2, LNP: 20.82, ALP: 19.14, TOP: 1.12 } }, rc = { pct: { OTH: 8.29, LNP: 50.01, ALP: 29.04, TOP: 2.56, GRN: 10.09 } }, ac = { pct: { IND: 5.32, ONP: 7.28, ALP: 28.21, GRN: 6.7, LNP: 44.24, TOP: 3.83, OTH: 4.41 } }, sc = { pct: { LNP: 47.45, IND: 7.87, TOP: 4.93, ALP: 17.96, GRN: 3.9, ONP: 10.44, OTH: 7.46 } }, ic = { pct: { ALP: 57.26, TOP: 4.77, GRN: 6.33, OTH: 8.83, LNP: 21.15, IND: 1.66 } }, lc = { pct: { GRN: 6.1, TOP: 5.79, ALP: 25.13, IND: 9.99, LNP: 49.14, OTH: 3.85 } }, cc = { pct: { OTH: 12.14, LNP: 17.18, GRN: 25.49, TOP: 2.97, ALP: 42.21 } }, uc = { pct: { OTH: 13.11, ALP: 37.86, LNP: 27.97, GRN: 10.41, TOP: 2.71, ONP: 7.94 } }, dc = { pct: { GRN: 8.81, ALP: 38.33, ONP: 5.44, OTH: 12.95, IND: 1.22, LNP: 31.27, TOP: 1.99 } }, fc = { pct: { OTH: 12.2, ONP: 6.72, GRN: 7.07, TOP: 2.12, LNP: 46.06, ALP: 25.83 } }, hc = { pct: { GRN: 9.53, ALP: 36.07, TOP: 2.42, OTH: 9.38, ONP: 5.33, LNP: 37.28 } }, pc = { pct: { TOP: 1.21, GRN: 15.05, LNP: 52.46, IND: 7.5, ONP: 1.15, OTH: 5.57, ALP: 17.06 } }, vc = { pct: { LNP: 51.84, OTH: 8.32, ONP: 9.08, GRN: 7.7, ALP: 20.51, TOP: 2.55 } }, gc = { pct: { GRN: 12.15, OTH: 9.87, LNP: 49.51, ONP: 5.6, IND: 1.29, ALP: 19.95, TOP: 1.63 } }, Nc = { pct: { OTH: 10.36, ALP: 35.97, ONP: 3.62, TOP: 1.83, LNP: 33.09, GRN: 15.13 } }, Pc = { pct: { OTH: 11.85, LNP: 41.23, ALP: 28.95, ONP: 4.99, TOP: 2.15, GRN: 10.83 } }, xc = { pct: { ONP: 4.4, LNP: 48.65, GRN: 11.48, OTH: 7.95, ALP: 23.27, IND: 2.56, TOP: 1.7 } }, mc = { pct: { LNP: 51.15, GRN: 7.9, ALP: 19.89, TOP: 1.74, OTH: 11.42, ONP: 7.9 } }, Oc = { pct: { ONP: 7.63, ALP: 27.02, LNP: 41.92, OTH: 11.67, GRN: 8.08, TOP: 2.32, IND: 1.36 } }, Ac = { pct: { OTH: 9.11, ALP: 32.86, LNP: 35.68, TOP: 1.81, GRN: 18.01, ONP: 2.54 } }, Lc = { pct: { LNP: 42.08, OTH: 11.08, GRN: 11.6, TOP: 1.66, ONP: 2.28, ALP: 31.29 } }, wc = { pct: { ALP: 24.81, ONP: 1.99, IND: 2.57, OTH: 7.57, GRN: 10.68, LNP: 51.28, TOP: 1.11 } }, Tc = {
  ...
  SWAN: Lc,
  TANG: wc
}, ao = no(), yc = { url: "https://abcnewsdata.sgp1.digitaloceanspaces.com/elections-2025-results-data__ash-test/latest.json" }, _c = {
  liveData: yc
...
function Vr(e, t) {
  le(t, !0);
  const [o, n] = No(), { resetViewboxPadding: r, setViewboxPadding: a } = vr("viewbox-padding") || {};
  let s = A(t, "arrowChart", 7), i = A(t, "hexes", 7), u = A(t, "offset", 7), l = fe(re({})), d = fe(void 0), c = /* @__PURE__ */ Y(() => String(s().split(" ")[0])), f = /* @__PURE__ */ Y(() => P(d) ? Cc(P(d), (v) => v === P(c)) : {});
  Ge(() => {
    const v = P(d), L = P(c), y = P(f);
    !v || !y || F(l, re(v.data.electorates.reduce(
      (x, N) => {
        var R;
        const m = N.code, T = (R = Tc[m]) == null ? void 0 : R.pct;
        let b = (T == null ? void 0 : T[L]) || 0;
...
for ${P(c)}: ${P(l)[v] ? P(l)[v].toFixed(3) + "%" : "not applicable"}`);
  ...
  const h = () => 20;
  st(() => {
    const v = a("HexMapArrowsFirsPreference", [30, 0, 30, 0]);
...
function $r(e, t) {
  le(t, !0);
  const [o, n] = No(), { resetViewboxPadding: r, setViewboxPadding: a } = vr("viewbox-padding") || {};
  let s = A(t, "hexes", 7), i = A(t, "offset", 7), u = fe(void 0), l = /* @__PURE__ */ Y(() => {
    const v = P(u);
    if (!v)
      return {};
  ...
  Ge(() => {
    It(ao, (v) => `Swing: ${P(l)[v] ? `${P(l)[v].toFixed(2)}% to ${P(l)[v] > 0 ? "ALP" : "Coalition"}` : "not applicable"}`);
  }), st(() => () => {
    It(ao, void 0);
  });
  ...
  st(() => {
    ...
    const v = a("HexMapArrowsSwing", [30, 0, 30, 0]);
    return () => r(v);
  });
  var f = pt(), p = nt(f);
  {
...
function Ec() {
  ...
  function r(s) {
    Er(t) === s && (e.set([0, 0, 0, 0]), t.set("none"));
  }
  const a = {
    setViewboxPadding: n,
    resetViewboxPadding: r
  };
  return ns("viewbox-padding", a), {
    viewboxPadding: e,
    viewboxApi: a
  };
}
function Sn(e, t = [0, 0, 0, 0]) {
  const [o, n, r, a] = t, [s, i, u, l] = e;
  return [s - a, i - o, u + a + n, l + o + r];
}
...
function Ur(e, t) {
  le(t, !0), Je(e, Gc);
  const [o, n] = No(), r = () => Cs($, "$viewboxPadding", o);
  let a = A(t, "config", 23, () => ({})), s = A(t, "layout", 23, () => ({})), i = A(t, "allocations", 23, () => ({})), u = A(t, "focuses", 23, () => ({})), l = A(t, "certainties", 23, () => ({})), d = A(t, "labelsToShow", 23, () => ({})), c = A(t, "showStateLabels", 7, !1), f = A(t, "showElectorateLabels", 7, !1), p = A(t, "showFocusedElectorateLabels", 7, !1), h = A(t, "isStaticLayout", 7, !1), g = A(t, "onClick", 7, ({ code: w }) => {
  }), v = A(t, "onHover", 7, ({ code: w }) => {
  }), L = A(t, "onFocus", 7, ({ code: w }) => {
  }), y = A(t, "customViewbox", 7, null), x = A(t, "onViewboxChange", 7, ({ newViewbox: w }) => {
  }), N = A(t, "isInteractive", 7, !1), m = A(t, "arrowChart", 7, "None"), T = A(t, "selectedElectorate", 7, null), b = A(t, "customElectorateAltText", 7), C = A(t, "showStateOutlinesOnTop", 7, !1), M = A(t, "isInline", 7, !1), R = A(t, "hexFlip", 7, "None"), k = fe(void 0), q = fe(0), _ = fe(0), E = fe(null), G = fe(null);
  const { viewboxPadding: $ } = Ec(), K = Sn(s().viewbox, r()), j = {
    easing: Ds,
    duration: M() ? 0 : 1100
  };
  let Ne = new ft(K[0], j), ae = new ft(K[1], j), oe = new ft(K[2], j), Ue = new ft(K[3], j);
  Ge(() => {
    const [w, Q, Ye, Oo] = Sn(y() || s().viewbox, r());
    Ne.set(w), ae.set(Q), oe.set(Ye), Ue.set(Oo);
  }), Ge(() => {
    x()(s().viewbox);
  }), st(() => {
    if (!P(k))
      return;
    const w = P(k).getBoundingClientRect();
    F(_, w.height / w.width);
  });
  let wt = /* @__PURE__ */ Y(() => yi({
    isInteractive: N(),
    onClick: g(),
    onHover: (w) => {
      F(G, re(w.code)), v()(w);
    ...
    let w = P(q), Q = oe.current;
    return w ? Q / w + 0.1 : 1;
  });
  var xe = Ic(), Ke = U(xe);
  let an;
  var lt = U(Ke), xo = U(lt), mo = U(xo), zr = U(mo);
  we(zr, "href", Sc), B(mo), B(xo);
  var sn = ee(xo);
        ...
        var dn = pt(), na = nt(dn);
        {
          var ra = (Ao) => {
            var fn = pt(), aa = nt(fn);
            {
              ...
              Ae(aa, (ct) => {
                m() === "Labor/Coalition 2CP Swing" ? ct(sa) : ct(ia, !1);
              });
            }
            V(Ao, fn);
          };
          Ae(na, (Ao) => {
            s().positions[P(Tt).name] && Ao(ra);
          });
        }
        V(Oo, dn);
      }), V(w, Q);
  ...
  B(xe), _e(
    (w, Q, Ye) => {
      an = Ho(
        ...
        "svelte-82t7dm"
      ), he(Ke, "aspect-ratio", w), we(lt, "viewBox", Q), we(mo, "patternTransform", Ye);
    },
    [
  ...
  ), Rs(lt, "clientWidth", (w) => F(q, w)), Pt(3, Ke, () => xt, () => ({ duration: M() ? 0 : 250 })), Pt(3, xe, () => xt, () => ({ duration: 750 })), V(e, xe);
  var oa = ce({
    get config() {
      return a();
    },
...
function Kr(e, t) {
  le(t, !0);
  const [o, n] = No();
  let r = A(t, "rootEl", 15), a = A(t, "colours", 7, Hn);
  Ge(() => {
    const i = a(), u = r();
    if (!u)
      return;
  ...
  function e(t) {
    ...
    function c(h) {
      ...
      for (var x = (y - L) * d + 1 >>> 0, N = new Uint8Array(x); L !== y; ) {
        for (var m = h[L], T = 0, b = x - 1; (m !== 0 || T < v) && b !== -1; b--, T++)
    ...
    function f(h) {
      ...
      for (var y = (h.length - g) * l + 1 >>> 0, x = new Uint8Array(y); h[g]; ) {
        ...
        if (N === 255)
          return;
        for (var m = 0, T = y - 1; (N !== 0 || m < L) && T !== -1; T--, m++)
          N += i * x[T] >>> 0, x[T] = N % 256 >>> 0, N = N / 256 >>> 0;
        if (N !== 0)
          throw new Error("Non-zero carry");
        L = m, g++;
      }
...
var Tu = /* @__PURE__ */ $e("<!> <div><!></div>", 1);
function yu(e, t) {
  le(t, !0);
  let o = A(t, "allocations", 23, () => ({})), n = A(t, "certainties", 23, () => ({})), r = A(t, "focuses", 23, () => ({})), a = A(t, "showStateLabels", 7, !1), s = A(t, "showElectorateLabels", 7, !1), i = A(t, "layout", 7, "COUNTRY"), u = A(t, "selectedElectorate", 7, null), l = A(t, "customViewbox", 7, null), d = A(t, "onClick", 7, () => {
  }), c = A(t, "onHover", 7, () => {
  }), f = A(t, "onFocus", 7, () => {
  }), p = A(t, "onApi", 7, () => {
  }), h = A(t, "onViewboxChange", 7, () => {
  }), g = A(t, "isStaticLayout", 7, !0), v = A(t, "isInteractive", 7, !0), L = A(t, "colours", 7), y = A(t, "customElectorateAltText", 23, () => ({})), x = A(t, "areStateOutlinesOnTop", 7), N = fe(void 0), m = /* @__PURE__ */ Y(() => au[i()]);
  function T(_, E, G, $ = !0) {
  ...
  function b(_) {
    ...
    const K = [-0.5, -1], [j, Ne] = Po(
      ...
      ""
    ).map(Number), ae = Number(E.coordPx[0] + j), oe = Number(E.coordPx[1] + Ne), [Ue, wt] = T(ae, oe, $), [Pe, xe] = T(ae, oe, $, !1);
    return {
      code: _,
      screenCoord: [Ue, wt],
