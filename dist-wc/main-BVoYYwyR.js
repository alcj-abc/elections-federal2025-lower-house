...
var ie = (e, t, n) => Ir(e, typeof t != 'symbol' ? t + '' : t, n),
  qn = (e, t, n) => t.has(e) || zn('Cannot ' + n);
var B = (e, t, n) => (qn(e, t, 'read from private field'), n ? n.call(e) : t.get(e)),
  He = (e, t, n) =>
    t.has(e) ? zn('Cannot add the same private member more than once') : t instanceof WeakSet ? t.add(e) : t.set(e, n),
  ft = (e, t, n, o) => (qn(e, t, 'write to private field'), o ? o.call(e, n) : t.set(e, n), n);
const Mr = '5';
...
function $(e, t) {
  return (
    M !== null &&
      !le &&
      Uo() &&
      M.f & (de | qt) && // If the source was created locally within the current derived, then
...
function ln(e, t) {
  return (
    e.equals(t) ||
      ...
      (e.wv = Fo()),
      Lo(e, Re),
      I !== null && I.f & Q && !(I.f & (ke | it)) && (Ae === null ? va([e]) : Ae.push(e))),
    t
  );
}
function Lo(e, t) {
  ...
  var t = de | Re,
    n =
      M !== null && M.f & de
        ...
        : null;
  return (
    I === null || (n !== null && n.f & ae) ? (t |= ae) : (I.f |= No),
    {
      ctx: Z,
      deps: null,
      effects: null,
...
function D(e) {
  if (T) {
    if (/* @__PURE__ */ be(k) !== null) throw (jt(), et);
    k = e;
  }
}
function Un(e = 1) {
  if (T) {
    for (var t = e, n = k; t--; ) n = /** @type {TemplateNode} */ /* @__PURE__ */ be(n);
    k = n;
  }
}
function cn() {
...
function ge(e, t = null, n) {
  ...
  return new Proxy(
    ...
    e,
    {
      ...
      deleteProperty(c, l) {
        var f = r.get(l);
        if (f === void 0) l in c && r.set(l, X(U));
        else {
      ...
      get(c, l, f) {
        ...
        if (
          (u === void 0 &&
            (!d || ((h = Le(c, l)) != null && h.writable)) &&
            ((u = X(ge(d ? c[l] : U, i))), r.set(l, u)),
          u !== void 0)
        ) {
          var v = b(u);
          return v === U ? void 0 : v;
      ...
      has(c, l) {
        ...
        if (l === tt) return !0;
        var f = r.get(l),
          u = (f !== void 0 && f.v !== U) || Reflect.has(c, l);
      ...
      set(c, l, f, u) {
        ...
        var d = r.get(l),
          v = l in c;
        if (a && l === 'length')
          for (var h = f; h < /** @type {Source<number>} */ d.v; h += 1) {
            var g = r.get(h + '');
            g !== void 0 ? $(g, U) : h in c && ((g = X(U)), r.set(h + '', g));
          }
        d === void 0
          ? (!v || ((m = Le(c, l)) != null && m.writable)) && ((d = X(void 0)), $(d, ge(f, i)), r.set(l, d))
          : ((v = d.v !== U), $(d, ge(f, i)));
      ...
      ownKeys(c) {
        ...
        for (var [f, u] of r) u.v !== U && !(f in c) && l.push(f);
        return l;
      },
      setPrototypeOf() {
        aa();
...
function un() {
  if (Yn === void 0) {
    ...
    var e = Element.prototype,
      t = Node.prototype;
    (Io = Le(t, 'firstChild').get),
      (Mo = Le(t, 'nextSibling').get),
      (e.__click = void 0),
...
function W(e, t) {
  if (!T) return /* @__PURE__ */ q(e);
  var n =
    /** @type {TemplateNode} */
    /* @__PURE__ */ q(k);
  if (n === null) n = k.appendChild(ot());
...
function ne(e, t = 1, n = !1) {
  let o = T ? k : e;
  for (var r; t--; ) (r = o), (o = /** @type {TemplateNode} */ /* @__PURE__ */ be(o));
  if (!T) return o;
  ...
  return se(o), /** @type {TemplateNode} */ o;
}
function Bo(e) {
  e.textContent = '';
}
  ...
  if (t & lt) {
    ...
    if (n !== null) {
      ...
      if (s || i) {
        ...
        for (r = 0; r < c; r++)
          (a = n[r]),
            (s || !((u = a == null ? void 0 : a.reactions) != null && u.includes(l))) &&
...
function Ho(e) {
  ...
  try {
    ...
    if (K !== null) {
      var d;
      if (($t(e, te), u !== null && te > 0)) for (u.length = te + K.length, d = 0; d < K.length; d++) u[te + d] = K[d];
      else e.deps = u = K;
      if (!De) for (d = te; d < u.length; d++) ((v = u[d]).reactions ?? (v.reactions = [])).push(e);
    } else u !== null && te < u.length && ($t(e, te), (u.length = te));
    if (Uo() && Ae !== null && !le && u !== null && !(e.f & (de | lt | Re)))
      for (d = 0; d < /** @type {Source[]} */ Ae.length; d++)
        $o(
          Ae[d],
          /** @type {Effect} */
          e
...
function xa(e, t) {
  ...
  n === null &&
    t.f & de && // Destroying a child effect while updating a parent effect can cause a dependency to appear
...
function $t(e, t) {
  var n = e.deps;
  if (n !== null) for (var o = t; o < n.length; o++) xa(e, n[o]);
}
function kn(e) {
  var t = e.f;
  if (!(t & Gt)) {
        ...
        try {
          _t(o) &&
            ...
            o.deps === null &&
              o.first === null &&
              o.nodes_start === null &&
              (o.teardown === null ? qo(o) : (o.fn = null)));
        } catch (r) {
          Ut(r, o, null, o.ctx);
        }
    }
...
function b(e) {
  ...
  if (M !== null && !le) {
    ...
    e.rv < Ft &&
      ((e.rv = Ft),
      K === null && o !== null && o[te] === e ? te++ : K === null ? (K = [e]) : (!De || !K.includes(e)) && K.push(e));
  } else if (n && /** @type {Derived} */ e.deps === null && /** @type {Derived} */ e.effects === null) {
    var r =
        /** @type {Derived} */
        e,
      a = r.parent;
  ...
  return n && ((r = /** @type {Derived} */ e), _t(r) && To(r)), e.v;
}
function mt(e) {
  var t = le;
  try {
...
function qo(e) {
  ...
  n !== null && (n.next = o),
    o !== null && (o.prev = n),
    t !== null && (t.first === e && (t.first = o), t.last === e && (t.last = n));
}
function rt(e, t) {
  var n = [];
  In(e, n, !0),
...
function Go(e, t) {
  ...
  if (n > 0) {
    var o = () => --n || t();
    for (var r of e) r.out(o);
  } else t();
}
function In(e, t, n) {
  if (!(e.f & Ce)) {
    if (((e.f ^= Ce), e.transitions !== null)) for (const s of e.transitions) (s.is_global || n) && t.push(s);
...
function Da(e, t, n, o = {}) {
  function r(a) {
    if ((o.capture || vt.call(t, a), !a.cancelBubble)) return Ko(() => (n == null ? void 0 : n.call(this, a)));
  }
  return (
...
function Qo(e) {
  for (var t = 0; t < e.length; t++) Yo.add(e[t]);
  for (var n of dn) n(e);
}
function vt(e) {
  var N;
  var t = this,
    n =
      ...
      t.ownerDocument,
    o = e.type,
    r = ((N = e.composedPath) == null ? void 0 : N.call(e)) || [],
    a =
      /** @type {null | Element} */
      r[0] || e.target,
    s = 0,
  ...
  if (i) {
    var c = r.indexOf(i);
    if (c !== -1 && (t === document || t === /** @type {any} */ window)) {
      e.__root = t;
      return;
    }
    var l = r.indexOf(t);
  ...
  if (((a = /** @type {Element} */ r[s] || e.target), a !== t)) {
    gt(e, 'currentTarget', {
      configurable: !0,
      get() {
        return a || n;
    ...
    try {
      for (var d, v = []; a !== null; ) {
        var h = a.assignedSlot || a.parentNode || /** @type {any} */ a.host || null;
        try {
          var g = a['__' + o];
          if (
            g !== void 0 &&
...
function Ie(e, t) {
  var n = (t & yo) !== 0,
    ...
    a = !e.startsWith('<!>');
  return () => {
    if (T) return ue(k, null), k;
    r === void 0 && ((r = Mn(a ? e : '<!>' + e)), n || (r = /** @type {Node} */ /* @__PURE__ */ q(r)));
    var s =
      /** @type {TemplateNode} */
...
function Ke(e, t, n = 'svg') {
  ...
  return () => {
    ...
    if (!s) {
      ...
      else s = /** @type {Element} */ /* @__PURE__ */ q(c);
    }
    var l =
      /** @type {TemplateNode} */
      s.cloneNode(!0);
  ...
  try {
    for (
      var a =
        /** @type {TemplateNode} */
        /* @__PURE__ */ q(n);
      a && (a.nodeType !== 8 || /** @type {Comment} */ a.data !== wo);
    ...
    if (k === null || k.nodeType !== 8 || /** @type {Comment} */ k.data !== En) throw (jt(), et);
    return ce(!1), /**  @type {Exports} */ s;
  } catch (s) {
    if (s === et) return t.recover === !1 && na(), un(), Bo(n), ce(!1), Xo(e, t);
    throw s;
  } finally {
    ce(o), se(r);
  }
...
function Wa(e, t, n, o) {
  for (var r = [], a = t.length, s = 0; s < a; s++) In(t[s].e, r, !0);
...
function Ge(e, t, n, o, r, a = null) {
  var s = e,
    i = { flags: t, items: /* @__PURE__ */ new Map(), first: null },
    c = (t & mo) !== 0;
  if (c) {
    var l =
      /** @type {Element} */
  ...
  Ue(() => {
    ...
    if (T) {
      for (var _ = null, N, m = 0; m < h; m++) {
        if (k.nodeType === 8 && /** @type {Comment} */ k.data === En) {
          (s = /** @type {Comment} */ k), (g = !0), ce(!1);
          break;
        }
        var x = v[m],
          p = o(x, m);
        (N = Jo(k, i, _, null, x, p, m, r, t, n)), i.items.set(p, N), (_ = N);
      }
      h > 0 && se(cn());
    }
    T || Va(v, i, s, r, t, o, n),
...
function Va(e, t, n, o, r, a, s) {
  ...
  if (i)
    for (p = 0; p < l; p += 1)
      (N = e[p]),
        (m = a(N, p)),
        (x = f.get(m)),
        x !== void 0 && ((J = x.a) == null || J.measure(), (g ?? (g = /* @__PURE__ */ new Set())).add(x));
  for (p = 0; p < l; p += 1) {
    if (((N = e[p]), (m = a(N, p)), (x = f.get(m)), x === void 0)) {
      var w = d
        ? /** @type {TemplateNode} */
          d.e.nodes_start
        : n;
      (h = Jo(w, t, h, h === null ? t.first : h.next, N, m, p, o, r, s)), f.set(m, h), (y = []), (_ = []), (d = h.next);
      continue;
    }
    if (
      (c && za(x, N, p, r),
      x.e.f & Ce && (Ht(x.e), i && ((G = x.a) == null || G.unfix(), (g ?? (g = /* @__PURE__ */ new Set())).delete(x))),
      x !== d)
    ) {
      if (v !== void 0 && v.has(x)) {
        if (y.length < _.length) {
          ...
          var O = y[0],
            L = y[y.length - 1];
          for (C = 0; C < y.length; C += 1) Zn(y[C], A, n);
          for (C = 0; C < _.length; C += 1) v.delete(_[C]);
          Me(t, O.prev, L.next), Me(t, h, O), Me(t, L, A), (d = A), (h = L), (p -= 1), (y = []), (_ = []);
        } else
          v.delete(x),
            Zn(x, d, n),
            Me(t, x.prev, x.next),
            Me(t, x, h === null ? t.first : h.next),
            Me(t, h, x),
            (h = x);
        continue;
      }
  ...
  if (d !== null || v !== void 0) {
    for (var R = v === void 0 ? [] : Cn(v); d !== null; ) d.e.f & Ce || R.push(d), (d = d.next);
    var F = R.length;
    if (F > 0) {
      var V = r & mo && l === 0 ? n : null;
      if (i) {
        for (p = 0; p < F; p += 1) (j = R[p].a) == null || j.measure();
        for (p = 0; p < F; p += 1) (ee = R[p].a) == null || ee.fix();
      }
      Wa(t, R, V, f);
    }
  }
  i &&
    ut(() => {
      var oe;
      if (g !== void 0) for (x of g) (oe = x.a) == null || oe.apply();
    }),
...
function tn(e, t, n, o, r) {
  ...
  Ue(() => {
    ...
    i !== void 0 && (fe(i), (i = void 0)),
      s !== '' &&
        (i = Te(() => {
          if (T) {
            k.data;
            for (var c = $e(), l = c; c !== null && (c.nodeType !== 8 || /** @type {Comment} */ c.data !== ''); )
              (l = c), (c = /** @type {TemplateNode} */ /* @__PURE__ */ be(c));
            if (c === null) throw (jt(), et);
            ue(k, l), (a = se(c));
            return;
          }
          var f = s + '';
    ...
    for (var r in n)
      if (n[r]) o = o ? o + ' ' + r : r;
        ...
        for (var a = r.length, s = 0; (s = o.indexOf(r, s)) >= 0; ) {
          var i = s + a;
          (s === 0 || Jn.includes(o[s - 1])) && (i === o.length || Jn.includes(o[i]))
            ? (o = (s === 0 ? '' : o.substring(0, s)) + o.substring(i + 1))
            : (s = i);
        }
  }
  return o === '' ? null : o;
...
function Bn(e, t, n, o, r, a) {
  ...
  if (T || s !== n) {
    var i = Ka(n, o, a);
    (!T || i !== e.getAttribute('class')) &&
      (i == null ? e.removeAttribute('class') : t ? (e.className = i) : e.setAttribute('class', i)),
      (e.__className = n);
  } else if (a) {
    r ?? (r = {});
    for (var c in a) {
...
function bt(e, t, n, o) {
  ...
  (T && ((r[t] = e.getAttribute(t)), t === 'src' || t === 'srcset' || (t === 'href' && e.nodeName === 'LINK'))) ||
    (r[t] !== (r[t] = n) &&
      (t === 'style' && '__styles' in e && (e.__styles = {}),
      t === 'loading' && (e[Gr] = n),
      n == null
        ? e.removeAttribute(t)
        : typeof n != 'string' && tr(e).includes(t)
        ? (e[t] = n)
        : e.setAttribute(t, n)));
}
  ...
  for (const m in n) {
    ...
    if (!(x === v && m !== 'class')) {
      ...
      if (h !== '$$') {
        ...
        } else if (m === 'style' && x != null) e.style.cssText = x + '';
        else if (m === 'autofocus')
          Ba(
            /** @type {HTMLElement} */
            e,
        ...
        else if (!a && (m === '__value' || (m === 'value' && x != null))) e.value = e.__value = x;
...
function pn(e, t, n, o, r) {
  ...
  return (
    (g.onfinish = () => {
      ...
      (g = e.animate(m, { duration: N, fill: 'forwards' })),
        (g.onfinish = () => {
...
function ar(e, t = pe) {
  ...
  function r(i) {
    if (Co(e, i) && ((e = i), n)) {
      const c = !Xe.length;
      for (const l of o) l[1](), Xe.push(l, e);
      if (c) {
        for (let l = 0; l < Xe.length; l += 2) Xe[l][0](Xe[l + 1]);
        Xe.length = 0;
      }
    }
  }
...
// @__NO_SIDE_EFFECTS__
function rs(e, t, n) {
  return new Proxy({ props: e, exclude: t }, os);
}
const as = {
  get(e, t) {
  ...
  has(e, t) {
    ...
    for (let n of e.props) if ((Ze(n) && (n = n()), n != null && t in n)) return !0;
    return !1;
  },
  ownKeys(e) {
    const t = [];
    for (let n of e.props) {
      Ze(n) && (n = n());
      for (const o in n) t.includes(o) || t.push(o);
    }
    return t;
  }
};
...
function S(e, t, n, o) {
  ...
  s
    ...
    : (l = /** @type {V} */ e[t]);
  var f = tt in e || Pn in e,
    u = (s && (((p = Le(e, t)) == null ? void 0 : p.set) ?? (f && t in e && (w => (e[t] = w))))) || void 0,
    d =
      /** @type {V} */
      o,
    v = !0,
...
class ls {
  ...
  constructor(t) {
    ...
    ft(
      ...
      (!((a = t == null ? void 0 : t.props) != null && a.$$host) || t.sync === !1) && E(),
      ft(this, Ee, r.$$events);
...
typeof HTMLElement == 'function' &&
  (sr = class extends HTMLElement {
    ...
    async connectedCallback() {
      if (((this.$$cn = !0), !this.$$c)) {
        ...
        for (const r of this.$$s)
          r in o &&
            (r === 'default' && !this.$$d.children ? ((this.$$d.children = t(r)), (n.default = !0)) : (n[r] = t(r)));
          ...
          (this.$$me = Ea(() => {
            Rn(() => {
              ...
              for (const a of Mt(this.$$c)) {
                ...
                this.$$d[a] = this.$$c[a];
                const s = Tt(a, this.$$d[a], this.$$p_d, 'toAttribute');
                s == null
    ...
    attributeChangedCallback(t, n, o) {
      ...
      this.$$r ||
        ((t = this.$$g_p(t)),
        (this.$$d[t] = Tt(t, o, this.$$p_d, 'toProp')),
...
function Ne(e, t, n, o, r, a) {
  let s = class extends sr {
    ...
    static get observedAttributes() {
      return Mt(t).map(i => (t[i].attribute || i).toLowerCase());
    }
  };
  return (
    Mt(t).forEach(i => {
...
const Hn = class Hn {
  ...
  set(t, n) {
    var u;
    $(B(this, nt), t);
    let { delay: o = 0, duration: r = 400, easing: a = us, interpolate: s = gn } = { ...B(this, wt), ...n };
    if (r === 0) return (u = B(this, We)) == null || u.abort(), $(B(this, Pe), t), Promise.resolve();
    const i = xe.now() + o;
    let c,
      l = !1,
      f = B(this, We);
    return (
      ft(
        ...
        or(d => {
          ...
          const v = d - i;
          return v > /** @type {number} */ r
            ? ($(B(this, Pe), t), !1)
            : ($(B(this, Pe), c(a(v / /** @type {number} */ r))), !0);
        })
      ),
      B(this, We).promise
    );
...
var hs = /* @__PURE__ */ Ie('<div class="state-labels__label svelte-dbcm70"> </div>'),
  vs = /* @__PURE__ */ Ie('<div aria-hidden="true"></div>');
const ps = {
  hash: 'svelte-dbcm70',
...
function lr(e, t) {
  ...
  return (
    ...
    D(r),
    Oe(() => (a = Bn(r, 1, 'state-labels svelte-dbcm70', null, a, { 'state-labels--overlaid': o() }))),
    H(e, r),
    ve({
      get labels() {
        return n();
...
var _s = /* @__PURE__ */ Ie('<li><button> </button></li>'),
  bs = /* @__PURE__ */ Ie('<li> <ul></ul></li>'),
  Ns = /* @__PURE__ */ Ie('<ul class="hexmapkeyboardnav svelte-1vj52vk"></ul>');
const As = {
  hash: 'svelte-1vj52vk',
...
function ur(e, t) {
  ...
  let c = /* @__PURE__ */ Y(() =>
    ['QLD', 'NT', 'WA', 'SA', 'NSW', 'ACT', 'VIC', 'TAS']
      .filter(l => o().positions[l])
      .map(l => n().find(f => f.name === l))
      .map(l => ({
        ...l,
...
function kt(e, t) {
  ...
  let n = S(t, 'groups', 7),
    ...
    s = /* @__PURE__ */ Y(() =>
      n()
        .flatMap(u => u.hexes.map(d => ({ ...d, group: u.name })))
        .sort((u, d) => u.index - d.index)
    ),
    i = /* @__PURE__ */ Y(() => {
      if (!o()) return;
      const u = b(s).find(m => m.id === o()),
        [d, v] = r().positions[u.group],
        [h, g] = u.coord,
        y = g % 2 ? 0.5 : 0,
        [_, N] = Fn([d + h + y, v + g], '').map(Number);
      return [_ - 3, N - 3];
    });
  var c = at(),
    l = Ve(c);
  {
    var f = u => {
      ...
      Un(), D(d), Oe(g => bt(d, 'transform', g), [() => `translate(${b(i).join(' ')}) scale(0.95)`]), H(u, d);
    };
    Fe(l, u => {
      b(i) && u(f);
    });
...
var Ls = typeof global == 'object' && global && global.Object === Object && global,
  ...
  dr = Ls || Os || Function('return this')(),
  Wt = dr.Symbol,
  fr = Object.prototype,
  Ts = fr.hasOwnProperty,
  ks = fr.toString,
  ht = Wt ? Wt.toStringTag : void 0;
function Rs(e) {
  var t = Ts.call(e, ht),
    n = e[ht];
  try {
...
function ei(e, t, n) {
  var o,
    ...
    u = !1,
    d = !0;
  if (typeof e != 'function') throw new TypeError(Xs);
  (t = io(t) || 0),
    xn(n) &&
      ((f = !!n.leading),
      (u = 'maxWait' in n),
      (a = u ? Zs(io(n.maxWait) || 0, t) : a),
  ...
  function p() {
    ...
    if (((o = arguments), (r = this), (c = w), A)) {
      if (i === void 0) return h(c);
      if (u) return clearTimeout(i), (i = setTimeout(_, t)), v(c);
    }
...
function ti({ isInteractive: e = !1, onClick: t, onHover: n }) {
  if (!e) return {};
  const o = ei(n, 10),
    r = ({ target: i, clientX: c, clientY: l }) => {
      var u;
...
var ni = /* @__PURE__ */ Ke('<g><text> </text><text class="hexlabels__text svelte-18lue6v"> </text></g>'),
  oi = /* @__PURE__ */ Ke('<g class="hexlabels svelte-18lue6v"></g>');
const ri = {
  hash: 'svelte-18lue6v',
...
function hr(e, t) {
  ...
  let n = S(t, 'hexes', 7),
    o = S(t, 'allocations', 7),
    r = S(t, 'certainties', 7),
    a = S(t, 'labelsToShow', 23, () => ({})),
    s = S(t, 'showElectorateLabels', 7, !1),
    i = /* @__PURE__ */ Y(() => (s() ? n() : n().filter(({ id: l }) => a()[l])));
  var c = oi();
  return (
    Ge(
      c,
      ...
      (l, f) => {
        ...
        D(N),
          ...
          Oe(
            x => {
              bt(h, 'transform', x),
                (y = Bn(g, 0, 'hexlabels__text svelte-18lue6v', null, y, {
                  'hexlabels__text--allocation': o()[u()]
                })),
                Se(g, 'stroke', `var(--u-${o()[u()]})`),
                Se(g, 'stroke-width', '3'),
                Se(g, 'opacity', o()[u()] && !r()[u()] ? 1 : 0),
                yt(_, v()),
                Se(N, 'fill', o()[u()] && r()[u()] ? 'white' : 'black'),
                yt(m, v());
            },
...
var ai = /* @__PURE__ */ Ke(
    '<g><g class="group-hexes svelte-ra45qz"><!></g><g class="group-outline group-outline__under svelte-ra45qz"><!></g></g>'
  ),
  si = /* @__PURE__ */ Ke('<g><g class="group-hex-strokes svelte-ra45qz"><!></g><!></g>'),
  ii = /* @__PURE__ */ Ke('<g><!><!></g>');
const li = {
  hash: 'svelte-ra45qz',
...
function vr(e, t) {
  he(t, !0), Ye(e, li);
  let n = S(t, 'groups', 7),
    o = S(t, 'isStaticLayout', 7),
    r = S(t, 'layout', 7),
    a = S(t, 'allocations', 7),
    s = S(t, 'focuses', 7),
    i = S(t, 'certainties', 7),
    c = S(t, 'showElectorateLabels', 7),
    l = S(t, 'showFocusedElectorateLabels', 7),
    f = S(t, 'labelsToShow', 7),
    u = S(t, 'isOutlineOnly', 7, !1),
    d = Be(void 0),
    v = /* @__PURE__ */ Y(() => {
    ...
    g = /* @__PURE__ */ Y(() => Object.values(s()).some(Boolean)),
    y = /* @__PURE__ */ Y(() => {
      var p;
      return Array.from(((p = b(d)) == null ? void 0 : p.querySelectorAll('polygon.hex')) || []).filter(
        w => w instanceof SVGPolygonElement
      );
    });
  ze(() => {
    const p = { ...a() },
...
function pr(e, t) {
  he(t, !0);
  let n = /* @__PURE__ */ rs(t, ['$$slots', '$$events', '$$legacy', '$$host']),
    o = Be(null);
  Dn(() => {
    import(
...
function gr(e, t) {
  ...
  let n = S(t, 'config', 23, () => ({})),
    o = S(t, 'layout', 23, () => ({})),
    r = S(t, 'allocations', 23, () => ({})),
    a = S(t, 'focuses', 23, () => ({})),
    s = S(t, 'certainties', 23, () => ({})),
    i = S(t, 'labelsToShow', 23, () => ({})),
    c = S(t, 'showStateLabels', 7, !1),
    l = S(t, 'showElectorateLabels', 7, !1),
    f = S(t, 'showFocusedElectorateLabels', 7, !1),
    u = S(t, 'isStaticLayout', 7, !1),
    d = S(t, 'onClick', 7, ({ code: P }) => {}),
    v = S(t, 'onHover', 7, ({ code: P }) => {}),
    h = S(t, 'onFocus', 7, ({ code: P }) => {}),
    g = S(t, 'customViewbox', 7, null),
    y = S(t, 'onViewboxChange', 7, ({ newViewbox: P }) => {}),
    _ = S(t, 'isInteractive', 7, !1),
    N = S(t, 'arrowChart', 7, 'None'),
    m = S(t, 'selectedElectorate', 7, null),
    x = Be(void 0),
    p = Be(0),
    w = Be(null),
    A = Be(null);
  const C = o().viewbox,
    O = { easing: ds, duration: 1100 };
  let L = new Je(C[0], O),
    R = new Je(C[1], O),
    F = new Je(C[2], O),
    V = new Je(C[3], O);
  ...
  return (
    ...
    Oe(
      ...
      [() => (b(p) ? b(p).toFixed(3) : null), () => [L.current, R.current, F.current, V.current].join(' ')]
    ),
    rr(
      3,
      G,
...
const hi = {
    black: '#000',
    white: '#fff',
    emptyStateOutline: 'black',
    stateOutline: '#949494',
    filledBorder: '#fff',
    empty: '#f1f1f1',
    emptyBorder: 'black',
    tileFocusBorder: 'black',
    tileFocusBorderGap: 'white',
    tileInteractBorder: 'black'
  },
  vi = {
    null: '#f1f1f1',
    nullBorder: '#fff',
...
const gi = {
    ...
    labels: [
      { left: 33.75, top: 30.75, width: 8, name: 'NT' },
      { left: 65.25, top: 21.5, width: 8, name: 'QLD' },
      { left: 57.75, top: 44.25, width: 8, name: 'NSW' },
      { left: 67.5, top: 57.75, width: 8, name: 'ACT' },
      { left: 58, top: 67.25, width: 8, name: 'VIC' },
      { left: 57.75, top: 86.25, width: 8, name: 'TAS' },
      { left: 34, top: 48.75, width: 8, name: 'SA' },
      { left: 24.5, top: 53.25, width: 8, name: 'WA' }
    ],
    overlayLabels: !0
  },
  xi = {
    ...
    labels: [
      { left: 30, top: 30.5, width: 8, name: 'NT' },
      { left: 62.5, top: 21.25, width: 8, name: 'QLD' },
      { left: 67.5, top: 47.75, width: 8, name: 'NSW' },
      { left: 71, top: 63.5, width: 8, name: 'ACT' },
      { left: 60.25, top: 75, width: 8, name: 'VIC' },
      { left: 60.25, top: 94.25, width: 8, name: 'TAS' },
      { left: 30, top: 52.25, width: 8, name: 'SA' },
      { left: 15.75, top: 52.25, width: 8, name: 'WA' }
    ],
    overlayLabels: !0
  },
  mi = {
  ...
  yi = {
    ...
    labels: [
      { left: 75, top: 80, width: 8, name: 'NT' },
      { left: 31, top: 40, width: 8, name: 'QLD' },
      { left: 29, top: 3.5, width: 8, name: 'NSW' },
      { left: 55, top: 80, width: 8, name: 'ACT' },
      { left: 74, top: 3.5, width: 8, name: 'VIC' },
      { left: 25, top: 80, width: 8, name: 'TAS' },
      { left: 85, top: 40, width: 8, name: 'SA' },
      { left: 56, top: 40, width: 8, name: 'WA' }
    ]
  },
  wi = {
    viewbox: [0, 0, 300, 300],
    positions: { ACT: [4, 2, !0] },
    labels: [{ left: 50, top: 10, width: 8, name: 'ACT' }]
  },
  _i = {
    viewbox: [0, 0, 300, 300],
    positions: { NSW: [0.15, 2] },
    labels: [{ left: 50, top: 10, width: 8, name: 'NSW' }]
  },
  bi = {
    viewbox: [0, 0, 300, 300],
    positions: { NT: [4.5, 2] },
    labels: [{ left: 50, top: 10, width: 8, name: 'NT' }]
  },
  Ni = {
    viewbox: [0, 0, 300, 300],
    positions: { QLD: [0.5, 2] },
    labels: [{ left: 50, top: 10, width: 8, name: 'QLD' }]
  },
  Ai = { viewbox: [0, 0, 300, 300], positions: { SA: [4, 2] }, labels: [{ left: 50, top: 10, width: 8, name: 'SA' }] },
  Ei = {
    viewbox: [0, 0, 300, 300],
    positions: { TAS: [4, 2] },
    labels: [{ left: 50, top: 10, width: 8, name: 'TAS' }]
  },
  Pi = {
    viewbox: [0, 0, 300, 300],
    positions: { VIC: [1.5, 2] },
    labels: [{ left: 50, top: 10, width: 8, name: 'VIC' }]
  },
  Si = {
    viewbox: [0, 0, 300, 300],
    positions: { WA: [3.5, 2] },
    labels: [{ left: 50, top: 10, width: 8, name: 'WA' }]
  },
  Ci = {
    viewbox: [0, 0, 480, 500],
    positions: { ACT: [8, 11.5, !0], NT: [7.75, 6, !0] },
    labels: [
      { left: 51, top: 25, width: 8, name: 'NT' },
      { left: 50.75, top: 51, width: 8, name: 'ACT' }
    ]
  },
  Li = {
    viewbox: [0, 0, 480, 500],
    positions: { NSW: [3.5, 12], QLD: [4.75, 3, !0] },
    labels: [
      { left: 73.25, top: 21.25, width: 8, name: 'QLD' },
      { left: 41, top: 85, width: 8, name: 'NSW' }
    ]
  },
  Oi = {
    viewbox: [0, 0, 480, 500],
    positions: { NSW: [3.75, 3, !0], VIC: [4.25, 12] },
    labels: [
      { left: 50.25, top: 8.75, width: 8, name: 'NSW' },
      { left: 50.75, top: 53.25, width: 8, name: 'VIC' }
    ]
  },
  Ti = {
    viewbox: [0, 0, 480, 500],
    positions: { QLD: [4.75, 3, !0], VIC: [4.25, 12] },
    labels: [
      { left: 41.75, top: 21.5, width: 8, name: 'QLD' },
      { left: 62.75, top: 61.75, width: 8, name: 'VIC' }
    ]
  },
  ki = {
    viewbox: [0, 0, 480, 500],
    positions: { QLD: [7, 7, !0], WA: [2, 5] },
    labels: [
      { left: 71.5, top: 28.25, width: 8, name: 'QLD' },
      { left: 11.75, top: 28.75, width: 8, name: 'WA' }
    ]
  },
  Ri = {
    viewbox: [0, 0, 480, 500],
    positions: { QLD: [1, 2], NSW: [7, 10], VIC: [0, 14] },
    labels: [
      { left: 37.25, top: 4, width: 8, name: 'QLD' },
      { left: 80.25, top: 43.5, width: 8, name: 'NSW' },
      { left: 17.5, top: 62.5, width: 8, name: 'VIC' }
    ]
  },
  Ii = {
    viewbox: [0, 0, 480, 500],
    positions: { SA: [7.25, 7, !0], TAS: [11, 9], WA: [2, 5] },
    labels: [
      { left: 72.5, top: 35.75, width: 8, name: 'TAS' },
      { left: 50.25, top: 26.5, width: 8, name: 'SA' },
      { left: 24.5, top: 18.75, width: 8, name: 'WA' }
    ]
  },
  mr = {
    COUNTRY: gi,
...
async function Fi({ schema: e, data: t }) {
  const n = yr(e),
    o = {},
    r = Object.entries(n).map(async ([a, s]) => {
      const { type: i, key: c, values: l, defaultValue: f, codec: u } = s;
      if (!co.includes(i)) throw new Error(`Unknown type "${i}", must be one of ${co}`);
      let d = t[c || a];
      if (typeof d > 'u') {
        typeof f < 'u' && (o[a] = f);
        return;
      ...
      if (
        (u && (d = await u.decode(d)),
        i === 'number' && (d = Number(d)),
        i === 'boolean' && (d = Number(d) === 1),
        i === 'enum')
      ) {
        const v = l[d];
        typeof v > 'u' ? (d = f) : (d = v);
...
async function $i({ schema: e, data: t }) {
  const n = yr(e),
    o = {},
    r = Object.keys(t).filter(s => !e[s]);
  if (r.length)
    throw (console.error(`Unknown keys found in data: ${r.join()}`), new Error('Unknown keys found in data'));
  const a = Object.entries(n).map(async ([s, i]) => {
    const { type: c, key: l, values: f, defaultValue: u, codec: d } = i,
      v = l || s,
      h = t[s];
    ...
    if (c === 'enum') {
      const y = f.indexOf(h);
      if (y === -1) throw (console.error(`Enum value "${h}" not found in ${f}`), new Error('Invalid enum value'));
      g = y;
    }
...
function Wi() {
  ...
  function e(t) {
    ...
    for (var n = new Uint8Array(256), o = 0; o < n.length; o++) n[o] = 255;
    for (var r = 0; r < t.length; r++) {
      var a = t.charAt(r),
        s = a.charCodeAt(0);
      if (n[s] !== 255) throw new TypeError(a + ' is ambiguous');
      n[s] = r;
    }
    var i = t.length,
      c = t.charAt(0),
      l = Math.log(i) / Math.log(256),
    ...
    function u(h) {
      ...
      for (var g = 0, y = 0, _ = 0, N = h.length; _ !== N && h[_] === 0; ) _++, g++;
      ...
      for (var C = m - y; C !== m && x[C] === 0; ) C++;
      for (var O = c.repeat(g); C < m; ++C) O += t.charAt(x[C]);
      return O;
    }
    function d(h) {
      if (typeof h != 'string') throw new TypeError('Expected String');
      if (h.length === 0) return new Uint8Array();
      for (var g = 0, y = 0, _ = 0; h[g] === c; ) y++, g++;
      ...
      for (var A = N - _; A !== N && m[A] === 0; ) A++;
      for (var C = new Uint8Array(y + (N - A)), O = y; A !== N; ) C[O++] = m[A++];
      return C;
    }
    function v(h) {
      var g = d(h);
...
const Gi = function (e) {
  ...
  ji = function (e, { delineator: t }) {
    ...
    const n = [];
    let o = e;
    for (let a = 0; a < e.length; a++) (o = Gi(o)), n.push(o);
    n.sort();
    let r = '';
    for (let a = 0; a < n.length; a++) r += n[a].charAt(n[a].length - 1);
    return r;
  },
  Ui = function (e, { delineator: t }) {
    ...
    for (let a = 0; a < e.length - 1; a++) {
      o.sort();
      for (let s = 0; s < e.length; s++) o[s] = e[s] + o[s];
    }
    return o
      .filter(function (a) {
...
function wr(e) {
  if (!e.match(/^[a-z]*$/))
    throw (
      (console.error('Unexpected characters in RLE encoder', e), new Error('RLE encoder only supports a-z values.'))
    );
  return e
    .split('')
    .reduce(
       ...
       */
      (t, n, o) => (
        o === 0 || n !== t[t.length - 1].char ? t.push({ char: n, repeated: 1 }) : t[t.length - 1].repeated++, t
      ),
      []
    )
...
function _r(e) {
  return e.replace(/(\w)(\d+)/g, (t, n, o) => n.repeat(+o));
}
...
function Qi({ delineator: e = 'q' }) {
  if (e.length !== 1) throw new Error('Delineator must be 1 char');
  return {
...
const mn = 26,
  yn = 97,
  Xi = 48,
  fo = async (e, { maxBits: t }) => {
    const n = [1, ...e].map(i => (i ? 1 : 0)).join(''),
      o = [];
    for (let i = n.length; i > 0; i -= t) o.push(n.slice(Math.max(0, i - t), i));
    return (
      o.reverse(),
      o
        .map(i => parseInt(i, 2))
        .map(i => (i > mn ? i % mn : String.fromCharCode(i + yn)))
        .join('')
    );
  };
async function ho(e, { maxBits: t }) {
  return e
    ...
    .map(i => (i >= yn ? i - yn : i - Xi + mn))
    .map((i, c) =>
      Number(i)
        .toString(2)
        .padStart(c > 0 ? t : 0, '0')
    )
    .flatMap(i => i.split('').map(c => c === '1'))
    .slice(1);
}
function Zi({ maxBits: e = 5 } = {}) {
  if (![4, 5].includes(e)) throw new Error('Bits must be 4 for alpha, and 5 for alphanumeric');
  return e === 4
    ? {
...
function Ji(e, t) {
  ...
  var n = t.propMap,
    ...
    s = t.noTypeGuessing,
    i = s === void 0 ? [] : s,
    c = e.match(/[A-Z]+([0-9a-z]|$)+/g) || [];
  (a = wn(a)), (i = wn(i));
  var l = c
    .map(function (f) {
      var u = f.match(/^([A-Z]+)([0-9a-z]*$)/) || [],
        d = u[1],
        v = u[2];
      if (typeof d != 'string' || typeof v != 'string') throw new Error('Error reading key/value pair');
      var h = o[d.toLowerCase()] || d.toLowerCase(),
        g = i.includes(h)
          ? v
    ...
    .reduce(
      ...
      function (f, u, d, v) {
        ...
        if (_) {
          ...
          if (N.size > 1) throw new Error("Inconsistent types in array property '".concat(h, "'"));
          f[h] = y;
        } else f[h] = g;
        return f;
      },
...
var vo = function (e) {
  ...
  if (t !== e) throw new Error('Illegal characters found: "'.concat(e, '"'));
  return e;
};
function el(e, t) {
  t === void 0 && (t = {});
  ...
  return (
    t().then(o => {
      n.set(o),
        n.subscribe(async r => {
          if (!r) return;
          const a = await $i({ schema: e, data: r }),
            s = '#' + el(a);
...
const nl = {
    ...
    'Inner-city Melbourne': [
      ...
      [145.25008324655565, -37.62851493730817]
    ],
    Perth: [
  ...
  st = $n.groups.flatMap(e => e.hexes.map(t => ({ ...t, group: e.name }))).sort((e, t) => e.index - t.index),
  al = Object.values(st).reduce((e, t) => ((e[t.id] = t), e), {});
$n.groups;
const _n = 'q',
  sl = 'x',
  po = Qi({ delineator: _n }),
  Nr = Es(br.hashCodes);
if (Nr[_n] || sl === _n) throw new Error('Can not use delineator in allocation map');
function Ar(e) {
...
const go = Zi({ maxBits: 4 }),
  ...
  an = Object.freeze(st.reduce((e, t) => ((e[t.id] = null), e), {})),
  ll = {
    version: {
      type: 'number',
      key: 'ver'
    ...
    allocations: {
      ...
      codec: {
        encode: async e => {
          const t = Object.entries(e).reduce((r, [a, s]) => ((r[a] = br.hashCodes[s] || 'x'), r), {}),
            n = Ar(t)
              .map(r => r ?? 'x')
              .join('');
        ...
        decode: async e =>
          (await po.decode(e).catch(o => (console.error('decoding string failed', e, o), '')))
            .split('')
            .reduce((o, r, a) => {
              var i;
              const s = (i = st[a]) == null ? void 0 : i.id;
              if (s) return (o[s] = Nr[String(r)] || null), o;
            }, {})
      },
      key: 'a',
      defaultValue: an
    ...
    certainties: {
      ...
      codec: rn,
      key: 'c',
      defaultValue: Object.freeze(st.reduce((e, t) => ((e[t.id] = !0), e), {}))
    },
    labelsToShow: {
      type: 'custom',
      codec: rn,
...
function ul(e, t) {
  he(t, !0);
  let n = S(t, 'allocations', 23, () => ({})),
    o = S(t, 'certainties', 23, () => ({})),
    r = S(t, 'focuses', 23, () => ({})),
    a = S(t, 'showStateLabels', 7, !1),
    s = S(t, 'showElectorateLabels', 7, !1),
    i = S(t, 'layout', 7, 'COUNTRY'),
    c = S(t, 'selectedElectorate', 7, null),
    l = S(t, 'customViewbox', 7, null),
    f = S(t, 'onClick', 7, () => {}),
    u = S(t, 'onHover', 7, () => {}),
    d = S(t, 'onFocus', 7, () => {}),
    v = S(t, 'onApi', 7, () => {}),
    h = S(t, 'onViewboxChange', 7, () => {}),
    g = S(t, 'isStaticLayout', 7, !0),
    y = S(t, 'isInteractive', 7, !0),
    _ = S(t, 'colours', 7),
    N = Be(void 0),
    m = /* @__PURE__ */ Y(() => mr[i()]);
  function x(L, R, F, V = !0) {
    const J = V ? F.getScreenCTM() : F.getCTM(),
      G = F.createSVGPoint();
    (G.x = L), (G.y = R);
  ...
  function p(L) {
    const R = al[L],
      F = b(m).positions[R == null ? void 0 : R.group];
    if (!(b(N) instanceof HTMLDivElement)) return;
    const V = b(N).querySelector('svg');
    if (!R || !F || !V) throw new Error(`Could not find hexagon with id ${L}`);
    const J = [-0.5, -1],
      [G, j] = Fn([F[0] + J[0], F[1] + J[1]], '').map(Number),
      ee = Number(R.coordPx[0] + G),
      oe = Number(R.coordPx[1] + j),
      [Nt, Xt] = x(ee, oe, V),
      [At, Et] = x(ee, oe, V, !1);
    return {
      code: L,
