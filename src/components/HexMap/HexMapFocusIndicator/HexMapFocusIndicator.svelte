<script lang="ts">
  ...
  let { groups, id, layout, type = 'focus' } = $props();
...
{#if coords}
  <g class="hex-map-focus-indicator" transform={`translate(${coords.join(' ')}) scale(0.95)`}>
    {#if type === 'focus'}
      <path
        style="color:#000000;fill:var(--c-tileFocusBorder);stroke-linecap:round;stroke-linejoin:round;-inkscape-stroke:none"
      ...
      />
      <path
        style="color:#000000;fill:var(--c-tileFocusBorderGap);stroke-linecap:round;stroke-linejoin:round;-inkscape-stroke:none"
    ...
    {/if}
    <path
      style="color:#000000;fill:var(--c-tileInteractBorder);stroke-linecap:round;stroke-linejoin:round;-inkscape-stroke:none"
